...
#include <unistd.h>
#include <signal.h>
#include "/Users/veitheller/.cache/carp/libs/github.com_COLON_carpentry-org/bufio/0.1.0/src/bufio.h"
#include "/Users/veitheller/.cache/carp/libs/github.com_COLON_carpentry-org/socket/0.1.1/src/tcp_stream.h"
#include "/Users/veitheller/.cache/carp/libs/github.com_COLON_carpentry-org/socket/0.1.1/src/tcp_bufio.h"
#include "/Users/veitheller/.cache/carp/libs/github.com_COLON_carpentry-org/socket/0.1.1/src/tcp_listener.h"
#include "/Users/veitheller/.cache/carp/libs/github.com_COLON_carpentry-org/socket/0.1.1/src/udp_socket.h"
#include "/Users/veitheller/.cache/carp/libs/github.com_COLON_carpentry-org/socket/0.1.1/src/unix_stream.h"
#include "/Users/veitheller/.cache/carp/libs/github.com_COLON_carpentry-org/socket/0.1.1/src/unix_bufio.h"
#include "/Users/veitheller/.cache/carp/libs/github.com_COLON_carpentry-org/socket/0.1.1/src/unix_listener.h"
#include "/Users/veitheller/.cache/carp/libs/github.com_COLON_carpentry-org/socket/0.1.1/src/poll.h"
...
typedef struct Pair__Array__uint8_t_String Pair__Array__uint8_t_String;
typedef struct Pair__RESP_int Pair__RESP_int;
...
typedef struct Result__Pair__Array__uint8_t_String_String Result__Pair__Array__uint8_t_String_String;
typedef struct Result__Pair__RESP_int_String Result__Pair__RESP_int_String;
typedef struct Result__Poll_String Result__Poll_String;
typedef struct Result__RESP_String Result__RESP_String;
typedef struct Result__Redis_String Result__Redis_String;
typedef struct Result__String_String Result__String_String;
typedef struct Result__TcpListener_String Result__TcpListener_String;
typedef struct Result__TcpStream_String Result__TcpStream_String;
typedef struct Result__UdpSocket_String Result__UdpSocket_String;
...
typedef struct Result__UnixListener_String Result__UnixListener_String;
typedef struct Result__UnixStream_String Result__UnixStream_String;
typedef struct Result__bool_String Result__bool_String;
typedef struct Result__int_String Result__int_String;
typedef struct Result__void_String Result__void_String;
...
#define Result__void_String_Success_tag 0
#define Result__void_String_Error_tag 1

// Depth 4
typedef Array Array__Array__RESP_MUL_;
...
// Depth 4
typedef Array Array__PollEvent;

// Depth 4
typedef Array Array__RESP;

// Depth 4
typedef Array Array__RESP_MUL_;
...
// Depth 4
typedef RESP*(*Fn__RESP_MUL__MUL__RESP_MUL_)(RESP**);

// Depth 4
typedef int(*Fn__String_MUL__Char_int)(String*, Char);

// Depth 4
typedef int(*Fn__String_MUL__Char_int_int)(String*, Char, int);
...
// Depth 4
typedef RESP*(*Fn__String_MUL__RESP_MUL_)(String*);
...
// Depth 6
typedef Result__void_String(*Fn__String_Result__void_String)(String);
...
// Depth 6
typedef Result__void_String(*Fn__void_Result__void_String)(void*);

// Depth 6
struct Pair__Array__uint8_t_String {
    Array__uint8_t a;
    String b;
};
...
struct RESP {
    ...
    struct {
        Array__RESP_MUL_ member0;
    } Arr;
    char __dummy;
    } u;
    char _tag;
};
#define RESP_Null_tag 0
#define RESP_Str_tag 1
#define RESP_Err_tag 2
#define RESP_Integer_tag 3
#define RESP_Arr_tag 4
...
// Depth 7
typedef String(*Fn__Array__RESP_MUL__MUL__String)(Array__RESP_MUL_*);

// Depth 7
typedef int(*Fn__Array__RESP_MUL__MUL__int)(Array__RESP_MUL_*);

// Depth 7
typedef RESP**(*Fn__Array__RESP_MUL__MUL__int_RESP_MUL__MUL_)(Array__RESP_MUL_*, int);

// Depth 7
typedef void(*Fn__Array__RESP_MUL__MUL__int_RESP_MUL__void)(Array__RESP_MUL_*, int, RESP*);
...
// Depth 7
typedef Array__RESP_MUL_(*Fn__Fn__String_MUL__RESP_MUL__MUL__Array__String_MUL__Array__RESP_MUL_)(Lambda*, Array__String*);
...
// Depth 7
typedef Array__RESP_MUL_(*Fn__int_Array__RESP_MUL_)(int);
...
// Depth 8
struct Result__Pair__Array__uint8_t_String_String {
    union {
    struct {
        Pair__Array__uint8_t_String member0;
    } Success;
    struct {
        String member0;
    } Error;
...
#define Result__Pair__Array__uint8_t_String_String_Success_tag 0
#define Result__Pair__Array__uint8_t_String_String_Error_tag 1

// Depth 8
struct Result__RESP_String {
    union {
    struct {
        RESP member0;
    } Success;
...
#define Result__RESP_String_Success_tag 0
#define Result__RESP_String_Error_tag 1

// Depth 8
struct Pair__RESP_int {
    RESP a;
    int b;
};

// Depth 9
typedef RESP(*Fn__Array__RESP_MUL__RESP)(Array__RESP_MUL_);

// Depth 9
typedef Result__Array__uint8_t_String(*Fn__Array__uint8_t_Result__Array__uint8_t_String)(Array__uint8_t);

// Depth 9
typedef Pair__Array__uint8_t_String(*Fn__Array__uint8_t_String_Pair__Array__uint8_t_String)(Array__uint8_t, String);

// Depth 9
typedef RESP(*Fn__RESP_MUL__RESP)(RESP*);

// Depth 9
typedef RESP*(*Fn__RESP_MUL__RESP_MUL_)(RESP*);

// Depth 9
typedef String(*Fn__RESP_MUL__String)(RESP*);

// Depth 9
typedef RESP*(*Fn__RESP_RESP_MUL_)(RESP);

// Depth 9
typedef RESP(*Fn__String_RESP)(String);

// Depth 9
typedef Result__Array__uint8_t_String(*Fn__String_Result__Array__uint8_t_String)(String);

// Depth 9
typedef RESP(*Fn___RESP)();

// Depth 9
typedef RESP(*Fn__int_RESP)(int);

// Depth 10
struct Result__Pair__RESP_int_String {
    union {
    struct {
        Pair__RESP_int member0;
    } Success;
    struct {
        String member0;
    } Error;
...
#define Result__Pair__RESP_int_String_Success_tag 0
#define Result__Pair__RESP_int_String_Error_tag 1

// Depth 10
typedef Array__RESP_MUL_(*Fn__Array__Array__RESP_MUL__MUL__Array__RESP_MUL_)(Array__Array__RESP_MUL_*);

// Depth 10
typedef int(*Fn__Array__Array__RESP_MUL__MUL__int)(Array__Array__RESP_MUL_*);

// Depth 10
typedef Array__RESP_MUL_*(*Fn__Array__Array__RESP_MUL__MUL__int_Array__RESP_MUL__MUL_)(Array__Array__RESP_MUL_*, int);
...
// Depth 11
typedef Result__Pair__Array__uint8_t_String_String(*Fn__Pair__Array__uint8_t_String_Result__Pair__Array__uint8_t_String_String)(Pair__Array__uint8_t_String);

// Depth 11
typedef RESP*(*Fn__Pair__RESP_int_MUL__RESP_MUL_)(Pair__RESP_int*);

// Depth 11
typedef int*(*Fn__Pair__RESP_int_MUL__int_MUL_)(Pair__RESP_int*);

// Depth 11
typedef Result__RESP_String(*Fn__RESP_Result__RESP_String)(RESP);

// Depth 11
typedef Pair__RESP_int(*Fn__RESP_int_Pair__RESP_int)(RESP, int);

// Depth 11
typedef Result__RESP_String(*Fn__String_MUL__Result__RESP_String)(String*);

// Depth 11
typedef Result__Pair__Array__uint8_t_String_String(*Fn__String_Result__Pair__Array__uint8_t_String_String)(String);

// Depth 11
typedef Result__RESP_String(*Fn__String_Result__RESP_String)(String);

// Depth 12
typedef int(*Fn__Array__RESP_MUL__int)(Array__RESP*);

// Depth 12
typedef RESP*(*Fn__Array__RESP_MUL__int_RESP_MUL_)(Array__RESP*, int);

// Depth 12
typedef Array__RESP_MUL_(*Fn__Fn__RESP_MUL__RESP_MUL__MUL__Array__RESP_MUL__Array__RESP_MUL_)(Lambda*, Array__RESP*);

// Depth 13
typedef Result__Pair__RESP_int_String(*Fn__Pair__RESP_int_Result__Pair__RESP_int_String)(Pair__RESP_int);

// Depth 13
typedef Result__Pair__RESP_int_String(*Fn__String_MUL__int_Result__Pair__RESP_int_String)(String*, int);

// Depth 13
typedef Result__Pair__RESP_int_String(*Fn__String_Result__Pair__RESP_int_String)(String);
...
#define Result__Poll_String_Success_tag 0
#define Result__Poll_String_Error_tag 1

// Depth 103
struct Result__TcpListener_String {
    union {
    struct {
        TcpListener member0;
    } Success;
...
#define Result__TcpListener_String_Success_tag 0
#define Result__TcpListener_String_Error_tag 1

// Depth 103
struct Result__TcpStream_String {
    union {
    struct {
        TcpStream member0;
    } Success;
...
#define Result__TcpStream_String_Success_tag 0
#define Result__TcpStream_String_Error_tag 1

// Depth 103
struct Result__UdpSocket_String {
    union {
    struct {
        UdpSocket member0;
    } Success;
...
#define Result__UdpSocket_String_Success_tag 0
#define Result__UdpSocket_String_Error_tag 1
...
// Depth 103
struct Result__UnixListener_String {
    union {
    struct {
        UnixListener member0;
    } Success;
    struct {
        String member0;
    } Error;
...
#define Result__UnixListener_String_Success_tag 0
#define Result__UnixListener_String_Error_tag 1

// Depth 103
struct Result__UnixStream_String {
    union {
    struct {
        UnixStream member0;
    } Success;
...
#define Result__UnixStream_String_Success_tag 0
#define Result__UnixStream_String_Error_tag 1
...
// Depth 104
typedef int(*Fn__BufReader_MUL__Array__uint8_t_MUL__int)(BufReader*, Array__uint8_t*);

// Depth 104
typedef String(*Fn__BufReader_MUL__Char_String)(BufReader*, Char);

// Depth 104
typedef String(*Fn__BufReader_MUL__String)(BufReader*);

// Depth 104
typedef int(*Fn__BufReader_MUL__String_MUL__int)(BufReader*, String*);

// Depth 104
typedef int(*Fn__BufReader_MUL__int)(BufReader*);

// Depth 104
typedef Array__uint8_t(*Fn__BufReader_MUL__int_Array__uint8_t)(BufReader*, int);
...
// Depth 104
typedef int(*Fn__Poll_MUL__int)(Poll*);

// Depth 104
typedef int(*Fn__Poll_MUL__int_int)(Poll*, int);

// Depth 104
typedef Result__void_String(*Fn__Poll_MUL__int_int_Result__void_String)(Poll*, int, int);

// Depth 104
typedef int(*Fn__Poll_MUL__int_int_int)(Poll*, int, int);

// Depth 104
typedef FILE*(*Fn__String_MUL__String_MUL__FILE_MUL_)(String*, String*);

// Depth 104
typedef UnixListener(*Fn__String_MUL__UnixListener)(String*);

// Depth 104
typedef UnixStream(*Fn__String_MUL__UnixStream)(String*);

// Depth 104
typedef TcpListener(*Fn__String_MUL__int_TcpListener)(String*, int);

// Depth 104
typedef TcpStream(*Fn__String_MUL__int_TcpStream)(String*, int);

// Depth 104
typedef UdpSocket(*Fn__String_MUL__int_UdpSocket)(String*, int);

// Depth 104
typedef int(*Fn__String_MUL__int_int_FILE_MUL__int)(String*, int, int, FILE*);

// Depth 104
typedef TcpStream(*Fn__String_MUL__int_int_TcpStream)(String*, int, int);

// Depth 104
typedef TcpStream(*Fn__TcpListener_MUL__TcpStream)(TcpListener*);

// Depth 104
typedef int(*Fn__TcpListener_MUL__int)(TcpListener*);

// Depth 104
typedef Array__uint8_t(*Fn__TcpStream_MUL__Array__uint8_t)(TcpStream*);

// Depth 104
typedef int(*Fn__TcpStream_MUL__Array__uint8_t_MUL__int)(TcpStream*, Array__uint8_t*);

// Depth 104
typedef Result__String_String(*Fn__TcpStream_MUL__Result__String_String)(TcpStream*);

// Depth 104
typedef String(*Fn__TcpStream_MUL__String)(TcpStream*);

// Depth 104
typedef Result__int_String(*Fn__TcpStream_MUL__String_MUL__Result__int_String)(TcpStream*, String*);

// Depth 104
typedef int(*Fn__TcpStream_MUL__String_MUL__int)(TcpStream*, String*);

// Depth 104
typedef int(*Fn__TcpStream_MUL__String_MUL__int_int)(TcpStream*, String*, int);

// Depth 104
typedef TcpStream(*Fn__TcpStream_MUL__TcpStream)(TcpStream*);

// Depth 104
typedef int(*Fn__TcpStream_MUL__int)(TcpStream*);

// Depth 104
typedef void(*Fn__TcpStream_MUL__int_void)(TcpStream*, int);

// Depth 104
typedef TcpStream(*Fn__TcpStream_TcpStream)(TcpStream);

// Depth 104
typedef void(*Fn__TcpStream_void)(TcpStream);

// Depth 104
typedef int(*Fn__UdpSocket_MUL__Array__uint8_t_MUL__String_MUL__int_MUL__int)(UdpSocket*, Array__uint8_t*, String*, int*);

// Depth 104
typedef int(*Fn__UdpSocket_MUL__String_MUL__int_Array__uint8_t_MUL__int)(UdpSocket*, String*, int, Array__uint8_t*);

// Depth 104
typedef int(*Fn__UdpSocket_MUL__int)(UdpSocket*);
...
// Depth 104
typedef UnixStream(*Fn__UnixListener_MUL__UnixStream)(UnixListener*);

// Depth 104
typedef int(*Fn__UnixListener_MUL__int)(UnixListener*);

// Depth 104
typedef Array__uint8_t(*Fn__UnixStream_MUL__Array__uint8_t)(UnixStream*);

// Depth 104
typedef int(*Fn__UnixStream_MUL__Array__uint8_t_MUL__int)(UnixStream*, Array__uint8_t*);

// Depth 104
typedef String(*Fn__UnixStream_MUL__String)(UnixStream*);

// Depth 104
typedef int(*Fn__UnixStream_MUL__String_MUL__int)(UnixStream*, String*);

// Depth 104
typedef int(*Fn__UnixStream_MUL__int)(UnixStream*);

// Depth 104
typedef void(*Fn__UnixStream_MUL__int_void)(UnixStream*, int);

// Depth 104
typedef ByteOrder(*Fn___ByteOrder)();

// Depth 104
typedef Poll(*Fn___Poll)();
...
#define Result__Redis_String_Success_tag 0
#define Result__Redis_String_Error_tag 1
...
// Depth 106
typedef Result__Poll_String(*Fn__Poll_Result__Poll_String)(Poll);

// Depth 106
typedef Result__RESP_String(*Fn__Redis_MUL__Result__RESP_String)(Redis*);

// Depth 106
typedef String(*Fn__Redis_MUL__String)(Redis*);

// Depth 106
typedef void(*Fn__Redis_MUL__String_Array__RESP_MUL__void)(Redis*, String, Array__RESP*);

// Depth 106
typedef TcpStream*(*Fn__Redis_MUL__TcpStream_MUL_)(Redis*);
...
// Depth 106
typedef Result__TcpStream_String(*Fn__String_MUL__int_Result__TcpStream_String)(String*, int);

// Depth 106
typedef Result__FILE_MUL__String(*Fn__String_Result__FILE_MUL__String)(String);

// Depth 106
typedef Result__Poll_String(*Fn__String_Result__Poll_String)(String);

// Depth 106
typedef Result__TcpListener_String(*Fn__String_Result__TcpListener_String)(String);

// Depth 106
typedef Result__TcpStream_String(*Fn__String_Result__TcpStream_String)(String);

// Depth 106
typedef Result__UdpSocket_String(*Fn__String_Result__UdpSocket_String)(String);

// Depth 106
typedef Result__UnixListener_String(*Fn__String_Result__UnixListener_String)(String);

// Depth 106
typedef Result__UnixStream_String(*Fn__String_Result__UnixStream_String)(String);

// Depth 106
typedef Result__TcpListener_String(*Fn__TcpListener_Result__TcpListener_String)(TcpListener);

// Depth 106
typedef Redis(*Fn__TcpStream_Redis)(TcpStream);

// Depth 106
typedef Result__TcpStream_String(*Fn__TcpStream_Result__TcpStream_String)(TcpStream);

// Depth 106
typedef Result__UdpSocket_String(*Fn__UdpSocket_Result__UdpSocket_String)(UdpSocket);
...
// Depth 106
typedef Result__UnixListener_String(*Fn__UnixListener_Result__UnixListener_String)(UnixListener);

// Depth 106
typedef Result__UnixStream_String(*Fn__UnixStream_Result__UnixStream_String)(UnixStream);
...
// Depth 107
typedef Array__PollEvent(*Fn__Poll_MUL__int_Array__PollEvent)(Poll*, int);
...
// Depth 108
typedef Result__Redis_String(*Fn__Redis_Result__Redis_String)(Redis);

// Depth 108
typedef Result__Redis_String(*Fn__String_MUL__int_Result__Redis_String)(String*, int);

// Depth 108
typedef Result__Redis_String(*Fn__String_Result__Redis_String)(String);
...
// Depth 505
typedef TcpStream(*Fn__LambdaEnv_TcpStream_TcpStream)(LambdaEnv, TcpStream);
...
// Depth 500
int poll_MINUS_read_MINUS_write;

// Depth 500
int poll_MINUS_write;
...
// Depth 500
Array Array_allocate__RESP_MUL_ (int n);
...
// Depth 500
void Array_aset_MINUS_uninitialized_BANG___RESP_MUL_ (Array *aRef, int n, RESP* newValue);
...
// Depth 500
Array__RESP_MUL_ Array_concat__RESP_MUL_(Array__Array__RESP_MUL_* xs);
...
// Depth 500
Array__RESP_MUL_ Array_copy_MINUS_map__RESP_RESP_MUL_(Lambda* f, Array__RESP* a);
...
// Depth 500
Array__RESP_MUL_ Array_copy_MINUS_map__String_RESP_MUL_(Lambda* f, Array__String* a);
...
// Depth 500
Array Array_copy__RESP_MUL_ (Array* a);
...
// Depth 500
void Array_delete__Array__RESP_MUL_ (Array a);
...
// Depth 500
void Array_delete__PollEvent (Array a);

// Depth 500
void Array_delete__RESP (Array a);

// Depth 500
void Array_delete__RESP_MUL_ (Array a);
...
// Depth 500
int Array_length__Array__RESP_MUL_ (Array *a);
...
// Depth 500
int Array_length__RESP (Array *a);

// Depth 500
int Array_length__RESP_MUL_ (Array *a);
...
// Depth 500
String Array_prn__RESP_MUL_(Array__RESP_MUL_* x);
...
// Depth 500
String Array_str__RESP_MUL_ (Array* a);

// Depth 500
Array__Char Array_suffix__Char(Array__Char* xs, int start_MINUS_index);

// Depth 500
int Array_sum_MINUS_length__RESP_MUL_(Array__Array__RESP_MUL_* xs);

// Depth 500
Array__RESP_MUL_* Array_unsafe_MINUS_nth__Array__RESP_MUL_ (Array *aRef, int n);
...
// Depth 500
RESP* Array_unsafe_MINUS_nth__RESP (Array *aRef, int n);

// Depth 500
RESP** Array_unsafe_MINUS_nth__RESP_MUL_ (Array *aRef, int n);
...
// Depth 500
RESP* Box_copy__RESP (RESP** box);

// Depth 500
void Box_delete__RESP (RESP* box);

// Depth 500
RESP* Box_init__RESP (RESP t);

// Depth 500
RESP* Box_peek__RESP(RESP** box_ref);

// Depth 500
String Box_prn__RESP (RESP** box);

// Depth 1000

// Depth 500
Result__void_String BufReader_flush(BufReader* br);

// Depth 500
Result__int_String BufReader_read_MINUS_append(BufReader* br, Array__uint8_t* buf);

// Depth 500
Result__String_String BufReader_read_MINUS_line(BufReader* br);

// Depth 500
Result__Array__uint8_t_String BufReader_read_MINUS_n(BufReader* br, int n);

// Depth 500
Result__String_String BufReader_read_MINUS_until(BufReader* br, Char delim);

// Depth 500
int BufReader_write(BufReader* br, String* data);

// Depth 500
int BufReader_write_MINUS_bytes(BufReader* br, Array__uint8_t* data);
...
// Depth 500
void Function_delete__RESP_MUL__RESP_MUL_ (Lambda f);

// Depth 500
void Function_delete__String_MUL__RESP_MUL_ (Lambda f);
...
// Depth 500
RESP* Pair_a__RESP_int(Pair__RESP_int* p);
...
// Depth 500
int* Pair_b__RESP_int(Pair__RESP_int* p);
...
// Depth 500
void Pair_delete__Array__uint8_t_String(Pair__Array__uint8_t_String p);

// Depth 500
void Pair_delete__RESP_int(Pair__RESP_int p);
...
// Depth 500
Pair__Array__uint8_t_String Pair_init__Array__uint8_t_String(Array__uint8_t a, String b);

// Depth 500
Pair__RESP_int Pair_init__RESP_int(RESP a, int b);
...
// Depth 500
Result__void_String Poll_add(Poll* poll, int fd, int interest);

// Depth 500
Result__Poll_String Poll_create();

// Depth 500
Result__void_String Poll_modify(Poll* poll, int fd, int interest);

// Depth 500
Result__void_String Poll_remove_MINUS_fd(Poll* poll, int fd);

// Depth 1000

// Depth 500
RESP RESP_Arr(Array__RESP_MUL_ member0);

// Depth 500
RESP RESP_Err(String member0);

// Depth 500
RESP RESP_Integer(int member0);

// Depth 500
RESP RESP_Null();

// Depth 500
RESP RESP_Str(String member0);

// Depth 500
String RESP_c;

// Depth 500
RESP RESP_copy(RESP* pRef);

// Depth 500
Result__Pair__RESP_int_String RESP_decode_MINUS_one(String* s, int pos);

// Depth 500
void RESP_delete(RESP p);

// Depth 500
Result__RESP_String RESP_from_MINUS_string(String* s);

// Depth 500
int RESP_get_MINUS_tag(RESP *p);

// Depth 500
String RESP_prn(RESP *p);

// Depth 500
String RESP_str(RESP* r);
...
// Depth 500
RESP* Redis__Lambda_send_20_env(String* x);

// Depth 500
RESP* Redis__Lambda_send_48_env(RESP* x);

// Depth 500
Result__RESP_String Redis_acl_MINUS_cat(Redis* r);

// Depth 500
Result__RESP_String Redis_acl_MINUS_genpass(Redis* r);

// Depth 500
Result__RESP_String Redis_acl_MINUS_list(Redis* r);

// Depth 500
Result__RESP_String Redis_acl_MINUS_load(Redis* r);

// Depth 500
Result__RESP_String Redis_acl_MINUS_log(Redis* r);

// Depth 500
Result__RESP_String Redis_acl_MINUS_save(Redis* r);

// Depth 500
Result__RESP_String Redis_acl_MINUS_users(Redis* r);

// Depth 500
Result__RESP_String Redis_acl_MINUS_whoami(Redis* r);

// Depth 500
Result__RESP_String Redis_bgrewriteaof(Redis* r);

// Depth 500
Result__RESP_String Redis_bgsave(Redis* r);

// Depth 500
Result__RESP_String Redis_client_MINUS_getname(Redis* r);

// Depth 500
Result__RESP_String Redis_client_MINUS_getredir(Redis* r);

// Depth 500
Result__RESP_String Redis_client_MINUS_id(Redis* r);

// Depth 500
Result__RESP_String Redis_client_MINUS_kill(Redis* r);

// Depth 500
Result__RESP_String Redis_client_MINUS_list(Redis* r);

// Depth 500
Result__RESP_String Redis_client_MINUS_reply(Redis* r);

// Depth 500
Result__RESP_String Redis_client_MINUS_trackinginfo(Redis* r);

// Depth 500
void Redis_close(Redis r);

// Depth 500
Result__RESP_String Redis_cluster_MINUS_bumpepoch(Redis* r);

// Depth 500
Result__RESP_String Redis_cluster_MINUS_failover(Redis* r);

// Depth 500
Result__RESP_String Redis_cluster_MINUS_flushslots(Redis* r);

// Depth 500
Result__RESP_String Redis_cluster_MINUS_info(Redis* r);

// Depth 500
Result__RESP_String Redis_cluster_MINUS_links(Redis* r);

// Depth 500
Result__RESP_String Redis_cluster_MINUS_myid(Redis* r);

// Depth 500
Result__RESP_String Redis_cluster_MINUS_nodes(Redis* r);

// Depth 500
Result__RESP_String Redis_cluster_MINUS_reset(Redis* r);

// Depth 500
Result__RESP_String Redis_cluster_MINUS_saveconfig(Redis* r);

// Depth 500
Result__RESP_String Redis_cluster_MINUS_shards(Redis* r);

// Depth 500
Result__RESP_String Redis_cluster_MINUS_slots(Redis* r);

// Depth 500
Result__RESP_String Redis_command(Redis* r);

// Depth 500
Result__RESP_String Redis_command_MINUS_count(Redis* r);

// Depth 500
Result__RESP_String Redis_command_MINUS_getkeys(Redis* r);

// Depth 500
Result__RESP_String Redis_command_MINUS_list(Redis* r);

// Depth 500
Result__RESP_String Redis_config_MINUS_resetstat(Redis* r);

// Depth 500
Result__RESP_String Redis_config_MINUS_rewrite(Redis* r);

// Depth 500
Result__RESP_String Redis_dbsize(Redis* r);

// Depth 500
Result__RESP_String Redis_debug_MINUS_segfault(Redis* r);

// Depth 500
void Redis_delete(Redis p);

// Depth 500
Result__RESP_String Redis_discard(Redis* r);

// Depth 500
Result__RESP_String Redis_exec(Redis* r);

// Depth 500
Result__RESP_String Redis_flushall(Redis* r);

// Depth 500
Result__RESP_String Redis_flushdb(Redis* r);

// Depth 500
Result__RESP_String Redis_function_MINUS_dump(Redis* r);

// Depth 500
Result__RESP_String Redis_function_MINUS_flush(Redis* r);

// Depth 500
Result__RESP_String Redis_function_MINUS_list(Redis* r);

// Depth 500
Result__RESP_String Redis_function_MINUS_stats(Redis* r);

// Depth 500
Result__RESP_String Redis_hello(Redis* r);

// Depth 500
Result__RESP_String Redis_info(Redis* r);

// Depth 500
Redis Redis_init(TcpStream sock);

// Depth 500
Result__RESP_String Redis_lastsave(Redis* r);

// Depth 500
Result__RESP_String Redis_latency_MINUS_doctor(Redis* r);

// Depth 500
Result__RESP_String Redis_latency_MINUS_help(Redis* r);

// Depth 500
Result__RESP_String Redis_latency_MINUS_histogram(Redis* r);

// Depth 500
Result__RESP_String Redis_latency_MINUS_latest(Redis* r);

// Depth 500
Result__RESP_String Redis_latency_MINUS_reset(Redis* r);

// Depth 500
Result__RESP_String Redis_lolwut(Redis* r);

// Depth 500
Result__RESP_String Redis_memory_MINUS_doctor(Redis* r);

// Depth 500
Result__RESP_String Redis_memory_MINUS_help(Redis* r);

// Depth 500
Result__RESP_String Redis_memory_MINUS_malloc_MINUS_stats(Redis* r);

// Depth 500
Result__RESP_String Redis_memory_MINUS_purge(Redis* r);

// Depth 500
Result__RESP_String Redis_memory_MINUS_stats(Redis* r);

// Depth 500
Result__RESP_String Redis_module_MINUS_list(Redis* r);

// Depth 500
Result__RESP_String Redis_monitor(Redis* r);

// Depth 500
Result__RESP_String Redis_multi(Redis* r);

// Depth 500
Result__Redis_String Redis_open(String* host);

// Depth 500
Result__Redis_String Redis_open_MINUS_on(String* host, int port);

// Depth 500
Result__RESP_String Redis_ping(Redis* r);

// Depth 500
String Redis_prn(Redis *p);

// Depth 500
Result__RESP_String Redis_punsubscribe(Redis* r);

// Depth 500
Result__RESP_String Redis_quit(Redis* r);

// Depth 500
Result__RESP_String Redis_randomkey(Redis* r);

// Depth 500
Result__RESP_String Redis_read(Redis* r);

// Depth 500
Result__RESP_String Redis_readonly(Redis* r);

// Depth 500
Result__RESP_String Redis_readwrite(Redis* r);

// Depth 500
Result__RESP_String Redis_reset(Redis* r);

// Depth 500
Result__RESP_String Redis_role(Redis* r);

// Depth 500
Result__RESP_String Redis_save(Redis* r);

// Depth 500
Result__RESP_String Redis_script_MINUS_flush(Redis* r);

// Depth 500
Result__RESP_String Redis_script_MINUS_kill(Redis* r);

// Depth 500
void Redis_send(Redis* r, String cmd, Array__RESP* args);

// Depth 500
Redis Redis_set_MINUS_sock(Redis p, TcpStream newValue);

// Depth 500
void Redis_set_MINUS_sock_BANG_(Redis* pRef, TcpStream newValue);

// Depth 500
Result__RESP_String Redis_shutdown(Redis* r);

// Depth 500
TcpStream* Redis_sock(Redis* p);

// Depth 500
String Redis_str(Redis *p);

// Depth 500
Result__RESP_String Redis_sunsubscribe(Redis* r);

// Depth 500
Result__RESP_String Redis_sync(Redis* r);

// Depth 500
Result__RESP_String Redis_time(Redis* r);

// Depth 500
Result__RESP_String Redis_unsubscribe(Redis* r);

// Depth 500
Result__RESP_String Redis_unwatch(Redis* r);

// Depth 500
Redis Redis_update_MINUS_sock(Redis p, Lambda *updater);

// Depth 500
Result__RESP_String Redis_xgroup(Redis* r);

// Depth 500
Result__RESP_String Redis_xinfo(Redis* r);

// Depth 500
Result__RESP_String Redis_xread(Redis* r);
...
// Depth 500
Result__Pair__Array__uint8_t_String_String Result_Error__String_Pair__Array__uint8_t_String(String member0);

// Depth 500
Result__Pair__RESP_int_String Result_Error__String_Pair__RESP_int(String member0);

// Depth 500
Result__Poll_String Result_Error__String_Poll(String member0);

// Depth 500
Result__RESP_String Result_Error__String_RESP(String member0);

// Depth 500
Result__Redis_String Result_Error__String_Redis(String member0);

// Depth 500
Result__String_String Result_Error__String_String(String member0);

// Depth 500
Result__TcpListener_String Result_Error__String_TcpListener(String member0);

// Depth 500
Result__TcpStream_String Result_Error__String_TcpStream(String member0);

// Depth 500
Result__UdpSocket_String Result_Error__String_UdpSocket(String member0);

// Depth 500
Result__UnixListener_String Result_Error__String_UnixListener(String member0);

// Depth 500
Result__UnixStream_String Result_Error__String_UnixStream(String member0);
...
// Depth 500
Result__void_String Result_Error__String_void(String member0);
...
// Depth 500
Result__Pair__Array__uint8_t_String_String Result_Success__Pair__Array__uint8_t_String_String(Pair__Array__uint8_t_String member0);

// Depth 500
Result__Pair__RESP_int_String Result_Success__Pair__RESP_int_String(Pair__RESP_int member0);

// Depth 500
Result__Poll_String Result_Success__Poll_String(Poll member0);

// Depth 500
Result__RESP_String Result_Success__RESP_String(RESP member0);

// Depth 500
Result__Redis_String Result_Success__Redis_String(Redis member0);

// Depth 500
Result__String_String Result_Success__String_String(String member0);

// Depth 500
Result__TcpListener_String Result_Success__TcpListener_String(TcpListener member0);

// Depth 500
Result__TcpStream_String Result_Success__TcpStream_String(TcpStream member0);

// Depth 500
Result__UdpSocket_String Result_Success__UdpSocket_String(UdpSocket member0);
...
// Depth 500
Result__UnixListener_String Result_Success__UnixListener_String(UnixListener member0);

// Depth 500
Result__UnixStream_String Result_Success__UnixStream_String(UnixStream member0);
...
// Depth 500
Result__void_String Result_Success__void_String();
...
// Depth 500
void Result_delete__Pair__Array__uint8_t_String_String(Result__Pair__Array__uint8_t_String_String p);

// Depth 500
void Result_delete__Pair__RESP_int_String(Result__Pair__RESP_int_String p);

// Depth 500
void Result_delete__Poll_String(Result__Poll_String p);

// Depth 500
void Result_delete__RESP_String(Result__RESP_String p);

// Depth 500
void Result_delete__Redis_String(Result__Redis_String p);

// Depth 500
void Result_delete__String_String(Result__String_String p);

// Depth 500
void Result_delete__TcpListener_String(Result__TcpListener_String p);

// Depth 500
void Result_delete__TcpStream_String(Result__TcpStream_String p);

// Depth 500
void Result_delete__UdpSocket_String(Result__UdpSocket_String p);
...
// Depth 500
void Result_delete__UnixListener_String(Result__UnixListener_String p);

// Depth 500
void Result_delete__UnixStream_String(Result__UnixStream_String p);
...
// Depth 500
void Result_delete__void_String(Result__void_String p);
...
// Depth 500
RESP String_to_MINUS_redis(String s);
...
// Depth 500
Result__TcpStream_String TcpListener_accept(TcpListener* listener);

// Depth 500
Result__TcpListener_String TcpListener_bind(String* addr, int port);

// Depth 500
int TcpListener_poll_MINUS_fd(TcpListener* l);

// Depth 1000

// Depth 500
Result__TcpStream_String TcpStream_connect(String* addr, int port);

// Depth 500
Result__TcpStream_String TcpStream_connect_MINUS_timeout(String* addr, int port, int timeout);

// Depth 500
int TcpStream_poll_MINUS_fd(TcpStream* s);

// Depth 500
Result__int_String TcpStream_read_MINUS_append(TcpStream* stream, Array__uint8_t* buf);

// Depth 500
Result__String_String TcpStream_read__String(TcpStream* stream);

// Depth 500
Result__int_String TcpStream_send(TcpStream* stream, String* msg);

// Depth 500
Result__int_String TcpStream_send_MINUS_bytes(TcpStream* stream, Array__uint8_t* data);

// Depth 500
Result__int_String TcpStream_send_MINUS_len(TcpStream* stream, String* msg, int len);

// Depth 500
void TcpStream_shutdown(TcpStream* stream, int how);

// Depth 1000

// Depth 500
Result__UdpSocket_String UdpSocket_bind(String* addr, int port);

// Depth 500
int UdpSocket_poll_MINUS_fd(UdpSocket* s);

// Depth 500
Result__Pair__Array__uint8_t_String_String UdpSocket_recv_MINUS_from(UdpSocket* sock);

// Depth 500
Result__int_String UdpSocket_send_MINUS_to(UdpSocket* sock, String* host, int port, Array__uint8_t* data);
...
// Depth 500
Result__UnixStream_String UnixListener_accept(UnixListener* listener);

// Depth 500
Result__UnixListener_String UnixListener_bind(String* path);

// Depth 500
int UnixListener_poll_MINUS_fd(UnixListener* l);

// Depth 1000

// Depth 500
Result__UnixStream_String UnixStream_connect(String* path);

// Depth 500
int UnixStream_poll_MINUS_fd(UnixStream* s);

// Depth 500
Result__int_String UnixStream_read_MINUS_append(UnixStream* stream, Array__uint8_t* buf);

// Depth 500
Result__int_String UnixStream_send(UnixStream* stream, String* msg);

// Depth 500
Result__int_String UnixStream_send_MINUS_bytes(UnixStream* stream, Array__uint8_t* data);

// Depth 500
void UnixStream_shutdown(UnixStream* stream, int how);
...
void carp_init_globals(int argc, char** argv) {
  ...
  SetConsoleOutputCP(CP_UTF8);
    ...
    // Depth 1
    {
        Array _11 = { .len = 1, .capacity = 1, .data = CARP_MALLOC(sizeof(RESP*) * 1) };
        RESP _9 = RESP_Null();
        RESP* _10 = Box_init__RESP(_9);
        ((RESP**)_11.data)[0] = _10;
        RESP _12 = RESP_Arr(_11);
        RESP* _13 = &_12; // ref
        RESP _14 = RESP_copy(_13);
        RESP* _15 = &_14; // ref
        String _16 = RESP_prn(_15);
        RESP_c = _16;
        RESP_delete(_12);
        RESP_delete(_14);
    }
...
Array Array_allocate__RESP_MUL_ (int n) {
    ...
    a.len = n;
    a.capacity = n;
    a.data = CARP_MALLOC(n*sizeof(RESP*));
    return a;
}
...
Array__RESP_MUL_ Array_concat__RESP_MUL_(Array__Array__RESP_MUL_* xs) {
    Array__RESP_MUL_ _97;
    /* let */ {
        int j = 0;
        int _10 = Array_length__Array__RESP_MUL_(xs);
        int lxs = _10;
        int _15 = Array_sum_MINUS_length__RESP_MUL_(xs);
        Array__RESP_MUL_ _16 = Array_allocate__RESP_MUL_(_15);
        Array__RESP_MUL_ result = _16;
        /* let */ {
            int i = 0;
            bool _1000008 = Int__LT_(i, lxs);
            bool _1000006 = _1000008;
            while (_1000006) {
                /* let */ {
                    Array__RESP_MUL_* _34 = Array_unsafe_MINUS_nth__Array__RESP_MUL_(xs, i);
                    Array__RESP_MUL_* arr = _34;
                    int _38 = Array_length__RESP_MUL_(arr);
                    int len = _38;
                    /* let */ {
                        int k = 0;
                        bool _1000017 = Int__LT_(k, len);
                        bool _1000015 = _1000017;
                        while (_1000015) {
                            Array__RESP_MUL_* _54 = &result; // ref
                            int _58 = Int__PLUS_(j, k);
                            RESP** _63 = Array_unsafe_MINUS_nth__RESP_MUL_(arr, k);
                            RESP* _64 = Box_copy__RESP(_63);
                            Array_aset_MINUS_uninitialized_BANG___RESP_MUL_(_54, _58, _64);
                            int _1000022 = Int__PLUS_(k, 1);
                            k = _1000022;  // Int = Int
                            bool _1000017 = Int__LT_(k, len);
                            _1000015 = _1000017;
                        }
                    }
                    int _81 = Int__PLUS_(j, len);
                    j = _81;  // Int = Int
                }
                int _1000026 = Int__PLUS_(i, 1);
                i = _1000026;  // Int = Int
                bool _1000008 = Int__LT_(i, lxs);
                _1000006 = _1000008;
            }
        }
        Array__RESP_MUL_ _96 = result;
        _97 = _96;
    }
    return _97;
}
...
Array__RESP_MUL_ Array_copy_MINUS_map__RESP_RESP_MUL_(Lambda* f, Array__RESP* a) {
    Array__RESP_MUL_ _52;
    /* let */ {
        int _10 = Array_length__RESP(a);
        Array__RESP_MUL_ _11 = Array_allocate__RESP_MUL_(_10);
        Array__RESP_MUL_ na = _11;
        /* let */ {
            int i = 0;
            int _23 = Array_length__RESP(a);
            bool _1000008 = Int__LT_(i, _23);
            bool _1000006 = _1000008;
            while (_1000006) {
                Array__RESP_MUL_* _29 = &na; // ref
                RESP* _37 = Array_unsafe_MINUS_nth__RESP(a, i);
                RESP* _38 = (*f).env ? ((RESP*(*)(LambdaEnv, RESP*))(*f).callback)((*f).env, _37) : ((RESP*(*)(RESP*))(*f).callback)(_37);
                Array_aset_MINUS_uninitialized_BANG___RESP_MUL_(_29, i, _38);
                int _1000013 = Int__PLUS_(i, 1);
                i = _1000013;  // Int = Int
                int _23 = Array_length__RESP(a);
                bool _1000008 = Int__LT_(i, _23);
...
Array__RESP_MUL_ Array_copy_MINUS_map__String_RESP_MUL_(Lambda* f, Array__String* a) {
    ...
    /* let */ {
        ...
        /* let */ {
            ...
            while (_1000006) {
                Array__RESP_MUL_* _29 = &na; // ref
                String* _37 = Array_unsafe_MINUS_nth__String(a, i);
                RESP* _38 = (*f).env ? ((RESP*(*)(LambdaEnv, String*))(*f).callback)((*f).env, _37) : ((RESP*(*)(String*))(*f).callback)(_37);
                Array_aset_MINUS_uninitialized_BANG___RESP_MUL_(_29, i, _38);
                int _1000013 = Int__PLUS_(i, 1);
                i = _1000013;  // Int = Int
                int _23 = Array_length__String(a);
...
Array Array_copy__RESP_MUL_ (Array* a){
    ...
    copy.data = CARP_MALLOC(sizeof(RESP*) * a->capacity);
    for(int i = 0; i < a->len; i++) {
        ((RESP**)(copy.data))[i] = Box_copy__RESP(&(((RESP**)a->data)[i]));
    }
    return copy;
}
...
void Array_delete__Array__RESP_MUL_ (Array a){
    for(int i = 0; i < a.len; i++) {
        Array_delete__RESP_MUL_(((Array__RESP_MUL_*)a.data)[i]);
    }
    CARP_FREE(a.data);
}
...
void Array_delete__PollEvent (Array a){
    for(int i = 0; i < a.len; i++) {
        /* Ignore non-managed type inside Array: 'PollEvent' */
    }
    CARP_FREE(a.data);
}
...
void Array_delete__RESP_MUL_ (Array a){
    for(int i = 0; i < a.len; i++) {
        Box_delete__RESP(((RESP**)a.data)[i]);
    }
    CARP_FREE(a.data);
}
...
int Array_length__Array__RESP_MUL_ (Array *a) { return (*a).len; }
...
int Array_length__RESP (Array *a) { return (*a).len; }
int Array_length__RESP_MUL_ (Array *a) { return (*a).len; }
...
String Array_prn__RESP_MUL_(Array__RESP_MUL_* x) {
    String _6 = Array_str__RESP_MUL_(x);
    return _6;
}
...
String Array_str__RESP_MUL_ (Array* a) {
  ...
  for(int i = 0; i < a->len; i++) {
    temp = Box_prn__RESP(&((RESP**)a->data)[i]);
...
int Array_sum_MINUS_length__RESP_MUL_(Array__Array__RESP_MUL_* xs) {
    ...
    /* let */ {
        ...
        /* let */ {
            ...
            bool _1000006 = _1000008;
            while (_1000006) {
                Array__RESP_MUL_* _31 = Array_unsafe_MINUS_nth__Array__RESP_MUL_(xs, i);
                int _32 = Array_length__RESP_MUL_(_31);
...
Array__RESP_MUL_* Array_unsafe_MINUS_nth__Array__RESP_MUL_ (Array *aRef, int n) {
    ...
    assert(n >= 0);
    assert(n < a.len);
    return &(((Array__RESP_MUL_*)a.data)[n]);
}
...
RESP* Box_init__RESP (RESP t) {
  RESP* instance;
  instance = CARP_MALLOC(sizeof(RESP));
  *instance = t;
  return instance;
}
...
Result__void_String BufReader_flush(BufReader* br) {
    Result__void_String _23;
    int _8 = BufReader_flush_(br);
    bool _10 = Int__EQ_(_8, -1);
    if (_10) {
        static String _14 = "write error";
        String *_14_ref = &_14;
        String _15 = String_copy(_14_ref);
        Result__void_String _16 = Result_Error__String_void(_15);
        Result__void_String _17 = _16;
        _23 = _17;
    } else {
        /* () */
        Result__void_String _21 = Result_Success__void_String();
        Result__void_String _22 = _21;
        _23 = _22;
    }
    return _23;
}
...
Result__int_String BufReader_read_MINUS_append(BufReader* br, Array__uint8_t* buf) {
    Result__int_String _30;
    /* let */ {
        int _10 = BufReader_read_MINUS_append_(br, buf);
        int n = _10;
        Result__int_String _29;
        bool _16 = Int__EQ_(n, -1);
        if (_16) {
            static String _20 = "read error";
            String *_20_ref = &_20;
            String _21 = String_copy(_20_ref);
            Result__int_String _22 = Result_Error__String_int(_21);
            Result__int_String _23 = _22;
            _29 = _23;
        } else {
            Result__int_String _27 = Result_Success__int_String(n);
...
Result__String_String BufReader_read_MINUS_line(BufReader* br) {
    ...
    /* let */ {
        String _8 = BufReader_read_MINUS_line_(br);
        String s = _8;
        Result__String_String _28;
        String* _14 = &s; // ref
        bool _15 = String_empty_QMARK_(_14);
        if (_15) {
            static String _19 = "connection closed";
            String *_19_ref = &_19;
            String _20 = String_copy(_19_ref);
            Result__String_String _21 = Result_Error__String_String(_20);
            Result__String_String _22 = _21;
            String_delete(s);
            _28 = _22;
        } else {
            Result__String_String _26 = Result_Success__String_String(s);
            Result__String_String _27 = _26;
            _28 = _27;
        }
        _29 = _28;
    }
...
Result__Array__uint8_t_String BufReader_read_MINUS_n(BufReader* br, int n) {
    Result__Array__uint8_t_String _34;
    /* let */ {
        Array__uint8_t _10 = BufReader_read_MINUS_n_(br, n);
        Array__uint8_t arr = _10;
        Result__Array__uint8_t_String _33;
        Array__uint8_t* _17 = &arr; // ref
        int _18 = Array_length__uint8_t(_17);
        bool _20 = Int__EQ_(_18, 0);
        if (_20) {
            static String _24 = "connection closed";
            String *_24_ref = &_24;
            String _25 = String_copy(_24_ref);
            Result__Array__uint8_t_String _26 = Result_Error__String_Array__uint8_t(_25);
            Result__Array__uint8_t_String _27 = _26;
            Array_delete__uint8_t(arr);
            _33 = _27;
        } else {
            Result__Array__uint8_t_String _31 = Result_Success__Array__uint8_t_String(arr);
            Result__Array__uint8_t_String _32 = _31;
            _33 = _32;
        }
        _34 = _33;
    }
...
Result__String_String BufReader_read_MINUS_until(BufReader* br, Char delim) {
    Result__String_String _31;
    /* let */ {
        String _10 = BufReader_read_MINUS_until_(br, delim);
        String s = _10;
        Result__String_String _30;
        String* _16 = &s; // ref
        bool _17 = String_empty_QMARK_(_16);
        if (_17) {
            static String _21 = "connection closed";
            String *_21_ref = &_21;
            String _22 = String_copy(_21_ref);
            Result__String_String _23 = Result_Error__String_String(_22);
            Result__String_String _24 = _23;
            String_delete(s);
            _30 = _24;
        } else {
            Result__String_String _28 = Result_Success__String_String(s);
            Result__String_String _29 = _28;
            _30 = _29;
        }
        _31 = _30;
    }
...
int BufReader_write(BufReader* br, String* data) {
    int _8 = BufReader_write_(br, data);
    return _8;
}

int BufReader_write_MINUS_bytes(BufReader* br, Array__uint8_t* data) {
    int _8 = BufReader_write_MINUS_bytes_(br, data);
    return _8;
}
...
RESP* Pair_a__RESP_int(Pair__RESP_int* p) { return (&(p->a)); }
...
int* Pair_b__RESP_int(Pair__RESP_int* p) { return (&(p->b)); }
...
Pair__Array__uint8_t_String Pair_init__Array__uint8_t_String(Array__uint8_t a, String b) {
    Pair__Array__uint8_t_String instance;
    instance.a = a;
    instance.b = b;
    return instance;
}
...
Result__void_String Poll_add(Poll* poll, int fd, int interest) {
    Result__void_String _26;
    int _12 = Poll_add_(poll, fd, interest);
    bool _14 = Int__EQ_(_12, -1);
    if (_14) {
        String _18 = System_error_MINUS_text();
        Result__void_String _19 = Result_Error__String_void(_18);
        Result__void_String _20 = _19;
        _26 = _20;
    } else {
        /* () */
        Result__void_String _24 = Result_Success__void_String();
        Result__void_String _25 = _24;
        _26 = _25;
    }
    return _26;
}
...
Result__Poll_String Poll_create() {
    Result__Poll_String _29;
    /* let */ {
        Poll _6 = Poll_create_();
        Poll p = _6;
        Result__Poll_String _28;
        Poll* _13 = &p; // ref
        int _14 = Poll_fd_(_13);
        bool _16 = Int__EQ_(_14, -1);
        if (_16) {
            String _20 = System_error_MINUS_text();
            Result__Poll_String _21 = Result_Error__String_Poll(_20);
            Result__Poll_String _22 = _21;
            _28 = _22;
        } else {
            Result__Poll_String _26 = Result_Success__Poll_String(p);
            Result__Poll_String _27 = _26;
            _28 = _27;
        }
        _29 = _28;
    }
...
Result__void_String Poll_modify(Poll* poll, int fd, int interest) {
    Result__void_String _26;
    int _12 = Poll_modify_(poll, fd, interest);
    bool _14 = Int__EQ_(_12, -1);
    if (_14) {
        String _18 = System_error_MINUS_text();
        Result__void_String _19 = Result_Error__String_void(_18);
...
Result__void_String Poll_remove_MINUS_fd(Poll* poll, int fd) {
    Result__void_String _24;
    int _10 = Poll_remove_(poll, fd);
    bool _12 = Int__EQ_(_10, -1);
    if (_12) {
        String _16 = System_error_MINUS_text();
        Result__void_String _17 = Result_Error__String_void(_16);
        Result__void_String _18 = _17;
        _24 = _18;
    } else {
        /* () */
        Result__void_String _22 = Result_Success__void_String();
        Result__void_String _23 = _22;
        _24 = _23;
    }
    return _24;
}
...
RESP RESP_Arr(Array__RESP_MUL_ member0) {
  RESP instance;
    instance.u.Arr.member0 = member0;
    instance._tag = RESP_Arr_tag;
    return instance;
}

RESP RESP_Err(String member0) {
  RESP instance;
    instance.u.Err.member0 = member0;
    instance._tag = RESP_Err_tag;
    return instance;
}
...
RESP RESP_Integer(int member0) {
  RESP instance;
    ...
    instance._tag = RESP_Integer_tag;
    return instance;
}
...
RESP RESP_Null() {
  RESP instance;
    ...
    instance._tag = RESP_Null_tag;
    return instance;
}

RESP RESP_Str(String member0) {
  RESP instance;
    instance.u.Str.member0 = member0;
    instance._tag = RESP_Str_tag;
    return instance;
}

RESP RESP_copy(RESP* pRef) {
    RESP copy = *pRef;
    if(pRef->_tag == RESP_Null_tag) {

    }

    else if(pRef->_tag == RESP_Str_tag) {
    copy.u.Str.member0 = String_copy(&(pRef->u.Str.member0));
    }

    else if(pRef->_tag == RESP_Err_tag) {
    copy.u.Err.member0 = String_copy(&(pRef->u.Err.member0));
    }

    else if(pRef->_tag == RESP_Integer_tag) {
    /* Ignore non-managed member 'u.Integer.member0' : Int */
    }

    else if(pRef->_tag == RESP_Arr_tag) {
    copy.u.Arr.member0 = Array_copy__RESP_MUL_(&(pRef->u.Arr.member0));
    }
...
Result__Pair__RESP_int_String RESP_decode_MINUS_one(String* s, int pos) {
    Result__Pair__RESP_int_String _547;
    int _10 = String_length(s);
    bool _11 = _GT__EQ___int(pos, _10);
    if (_11) {
        RESP _16 = RESP_Null();
        Pair__RESP_int _18 = Pair_init__RESP_int(_16, pos);
        Result__Pair__RESP_int_String _19 = Result_Success__Pair__RESP_int_String(_18);
        Result__Pair__RESP_int_String _20 = _19;
        _547 = _20;
    } else {
        Result__Pair__RESP_int_String _545;
        /* let */ {
            Char _27 = String_char_MINUS_at(s, pos);
            Char gensym_MINUS_generated1039 = _27;
            Result__Pair__RESP_int_String _544;
            bool _33 = Char__EQ_(gensym_MINUS_generated1039, 43/*'+'*/);
            if (_33) {
                Result__Pair__RESP_int_String _78;
                /* let */ {
                    int _40 = Int__PLUS_(pos, 1);
                    int rest_MINUS_start = _40;
                    int _46 = String_index_MINUS_of_MINUS_from(s, 13/*'\r'*/, rest_MINUS_start);
                    int idx = _46;
                    Result__Pair__RESP_int_String _77;
                    bool _52 = Int__EQ_(idx, -1);
                    if (_52) {
                        static String _56 = "Malformed simple string";
                        String *_56_ref = &_56;
                        String _57 = String_copy(_56_ref);
                        Result__Pair__RESP_int_String _58 = Result_Error__String_Pair__RESP_int(_57);
                        Result__Pair__RESP_int_String _59 = _58;
                        _77 = _59;
                    } else {
                        String _68 = String_slice(s, rest_MINUS_start, idx);
                        RESP _69 = RESP_Str(_68);
                        int _73 = Int__PLUS_(idx, 2);
                        Pair__RESP_int _74 = Pair_init__RESP_int(_69, _73);
                        Result__Pair__RESP_int_String _75 = Result_Success__Pair__RESP_int_String(_74);
                        Result__Pair__RESP_int_String _76 = _75;
                        _77 = _76;
                    }
                    _78 = _77;
                }
                Result__Pair__RESP_int_String _79 = _78;
                _544 = _79;
            } else {
                Result__Pair__RESP_int_String _542;
                bool _85 = Char__EQ_(gensym_MINUS_generated1039, 45/*'-'*/);
                if (_85) {
                    Result__Pair__RESP_int_String _130;
                    /* let */ {
                        int _92 = Int__PLUS_(pos, 1);
                        int rest_MINUS_start = _92;
                        int _98 = String_index_MINUS_of_MINUS_from(s, 13/*'\r'*/, rest_MINUS_start);
                        int idx = _98;
                        Result__Pair__RESP_int_String _129;
                        bool _104 = Int__EQ_(idx, -1);
                        if (_104) {
                            static String _108 = "Malformed error string";
                            String *_108_ref = &_108;
                            String _109 = String_copy(_108_ref);
                            Result__Pair__RESP_int_String _110 = Result_Error__String_Pair__RESP_int(_109);
                            Result__Pair__RESP_int_String _111 = _110;
                            _129 = _111;
                        } else {
                            String _120 = String_slice(s, rest_MINUS_start, idx);
                            RESP _121 = RESP_Err(_120);
                            int _125 = Int__PLUS_(idx, 2);
                            Pair__RESP_int _126 = Pair_init__RESP_int(_121, _125);
                            Result__Pair__RESP_int_String _127 = Result_Success__Pair__RESP_int_String(_126);
                            Result__Pair__RESP_int_String _128 = _127;
                            _129 = _128;
                        }
                        _130 = _129;
                    }
                    Result__Pair__RESP_int_String _131 = _130;
                    _542 = _131;
                } else {
                    Result__Pair__RESP_int_String _540;
                    bool _137 = Char__EQ_(gensym_MINUS_generated1039, 58/*':'*/);
                    if (_137) {
                        Result__Pair__RESP_int_String _199;
                        /* let */ {
                            int _144 = Int__PLUS_(pos, 1);
                            int rest_MINUS_start = _144;
                            int _150 = String_index_MINUS_of_MINUS_from(s, 13/*'\r'*/, rest_MINUS_start);
                            int idx = _150;
                            Result__Pair__RESP_int_String _198;
                            bool _156 = Int__EQ_(idx, -1);
                            if (_156) {
                                static String _160 = "Malformed integer";
                                String *_160_ref = &_160;
                                String _161 = String_copy(_160_ref);
                                Result__Pair__RESP_int_String _162 = Result_Error__String_Pair__RESP_int(_161);
                                Result__Pair__RESP_int_String _163 = _162;
                                _198 = _163;
                            } else {
                                String _172 = String_slice(s, rest_MINUS_start, idx);
                                String* _173 = &_172; // ref
                                Maybe__int _174 = Int_from_MINUS_string(_173);
                                Result__Pair__RESP_int_String _196;
                                if(_174._tag == Maybe__int_Nothing_tag) {
                                    Maybe__int _174_temp = _174;
                                    // Case expr:
                                    static String _179 = "Could not parse integer in result.";
                                    String *_179_ref = &_179;
                                    String _180 = String_copy(_179_ref);
                                    Result__Pair__RESP_int_String _181 = Result_Error__String_Pair__RESP_int(_180);
                                    _196 = _181;
                                }
                                else if(_174._tag == Maybe__int_Just_tag) {
                                    Maybe__int _174_temp = _174;
                                    int n = _174_temp.u.Just.member0;
                                    // Case expr:
                                    RESP _189 = RESP_Integer(n);
                                    int _193 = Int__PLUS_(idx, 2);
                                    Pair__RESP_int _194 = Pair_init__RESP_int(_189, _193);
                                    Result__Pair__RESP_int_String _195 = Result_Success__Pair__RESP_int_String(_194);
                                    _196 = _195;
                                }
                                else UNHANDLED("redis.carp", 59);
                                Result__Pair__RESP_int_String _197 = _196;
                                String_delete(_172);
                                _198 = _197;
                            }
                            _199 = _198;
                        }
                        Result__Pair__RESP_int_String _200 = _199;
                        _540 = _200;
                    } else {
                        Result__Pair__RESP_int_String _538;
                        bool _206 = Char__EQ_(gensym_MINUS_generated1039, 36/*'$'*/);
                        if (_206) {
                            Result__Pair__RESP_int_String _306;
                            /* let */ {
                                int _213 = Int__PLUS_(pos, 1);
                                int rest_MINUS_start = _213;
                                int _219 = String_index_MINUS_of_MINUS_from(s, 13/*'\r'*/, rest_MINUS_start);
                                int idx = _219;
                                Result__Pair__RESP_int_String _305;
                                bool _225 = Int__EQ_(idx, -1);
                                if (_225) {
                                    static String _229 = "Malformed bulk string";
                                    String *_229_ref = &_229;
                                    String _230 = String_copy(_229_ref);
                                    Result__Pair__RESP_int_String _231 = Result_Error__String_Pair__RESP_int(_230);
                                    Result__Pair__RESP_int_String _232 = _231;
                                    _305 = _232;
                                } else {
                                    String _241 = String_slice(s, rest_MINUS_start, idx);
                                    String* _242 = &_241; // ref
                                    Maybe__int _243 = Int_from_MINUS_string(_242);
                                    Result__Pair__RESP_int_String _303;
                                    if(_243._tag == Maybe__int_Nothing_tag) {
                                        Maybe__int _243_temp = _243;
                                        // Case expr:
                                        static String _248 = "Error decoding bulk string: does not start with length!";
                                        String *_248_ref = &_248;
                                        String _249 = String_copy(_248_ref);
                                        Result__Pair__RESP_int_String _250 = Result_Error__String_Pair__RESP_int(_249);
                                        _303 = _250;
                                    }
                                    else if(_243._tag == Maybe__int_Just_tag) {
                                        Maybe__int _243_temp = _243;
                                        int len = _243_temp.u.Just.member0;
                                        // Case expr:
                                        Result__Pair__RESP_int_String _302;
                                        bool _258 = Int__EQ_(len, -1);
                                        if (_258) {
                                            RESP _263 = RESP_Null();
                                            int _267 = Int__PLUS_(idx, 2);
                                            Pair__RESP_int _268 = Pair_init__RESP_int(_263, _267);
                                            Result__Pair__RESP_int_String _269 = Result_Success__Pair__RESP_int_String(_268);
                                            Result__Pair__RESP_int_String _270 = _269;
                                            _302 = _270;
                                        } else {
                                            Result__Pair__RESP_int_String _300;
                                            /* let */ {
                                                int _277 = Int__PLUS_(idx, 2);
                                                int data_MINUS_start = _277;
                                                int _288 = Int__PLUS_(data_MINUS_start, len);
                                                String _289 = String_slice(s, data_MINUS_start, _288);
                                                RESP _290 = RESP_Str(_289);
                                                int _296 = Int__PLUS_(len, 2);
                                                int _297 = Int__PLUS_(data_MINUS_start, _296);
                                                Pair__RESP_int _298 = Pair_init__RESP_int(_290, _297);
                                                Result__Pair__RESP_int_String _299 = Result_Success__Pair__RESP_int_String(_298);
                                                _300 = _299;
                                            }
                                            Result__Pair__RESP_int_String _301 = _300;
                                            _302 = _301;
                                        }
                                        _303 = _302;
                                    }
                                    else UNHANDLED("redis.carp", 67);
                                    Result__Pair__RESP_int_String _304 = _303;
                                    String_delete(_241);
                                    _305 = _304;
                                }
                                _306 = _305;
                            }
                            Result__Pair__RESP_int_String _307 = _306;
                            _538 = _307;
                        } else {
                            Result__Pair__RESP_int_String _536;
                            bool _313 = Char__EQ_(gensym_MINUS_generated1039, 42/*'*'*/);
                            if (_313) {
                                Result__Pair__RESP_int_String _513;
                                /* let */ {
                                    int _320 = Int__PLUS_(pos, 1);
                                    int rest_MINUS_start = _320;
                                    int _326 = String_index_MINUS_of_MINUS_from(s, 13/*'\r'*/, rest_MINUS_start);
                                    int idx = _326;
                                    Result__Pair__RESP_int_String _512;
                                    bool _332 = Int__EQ_(idx, -1);
                                    if (_332) {
                                        static String _336 = "Malformed array";
                                        String *_336_ref = &_336;
                                        String _337 = String_copy(_336_ref);
                                        Result__Pair__RESP_int_String _338 = Result_Error__String_Pair__RESP_int(_337);
                                        Result__Pair__RESP_int_String _339 = _338;
                                        _512 = _339;
                                    } else {
                                        String _348 = String_slice(s, rest_MINUS_start, idx);
                                        String* _349 = &_348; // ref
                                        Maybe__int _350 = Int_from_MINUS_string(_349);
                                        Result__Pair__RESP_int_String _510;
                                        if(_350._tag == Maybe__int_Nothing_tag) {
                                            Maybe__int _350_temp = _350;
                                            // Case expr:
                                            static String _355 = "Error decoding array: does not start with length!";
                                            String *_355_ref = &_355;
                                            String _356 = String_copy(_355_ref);
                                            Result__Pair__RESP_int_String _357 = Result_Error__String_Pair__RESP_int(_356);
                                            _510 = _357;
                                        }
                                        else if(_350._tag == Maybe__int_Just_tag) {
                                            Maybe__int _350_temp = _350;
                                            int len = _350_temp.u.Just.member0;
                                            // Case expr:
                                            Result__Pair__RESP_int_String _509;
                                            bool _365 = Int__EQ_(len, -1);
                                            if (_365) {
                                                RESP _370 = RESP_Null();
                                                int _374 = Int__PLUS_(idx, 2);
                                                Pair__RESP_int _375 = Pair_init__RESP_int(_370, _374);
                                                Result__Pair__RESP_int_String _376 = Result_Success__Pair__RESP_int_String(_375);
                                                Result__Pair__RESP_int_String _377 = _376;
                                                _509 = _377;
                                            } else {
                                                Result__Pair__RESP_int_String _507;
                                                bool _383 = Int__EQ_(len, 0);
                                                if (_383) {
                                                    Array _388 = { .len = 0, .capacity = 0, .data = CARP_MALLOC(sizeof(RESP*) * 0) };
                                                    RESP _389 = RESP_Arr(_388);
                                                    int _393 = Int__PLUS_(idx, 2);
                                                    Pair__RESP_int _394 = Pair_init__RESP_int(_389, _393);
                                                    Result__Pair__RESP_int_String _395 = Result_Success__Pair__RESP_int_String(_394);
                                                    Result__Pair__RESP_int_String _396 = _395;
                                                    _507 = _396;
                                                } else {
                                                    Result__Pair__RESP_int_String _505;
                                                    /* let */ {
                                                        int _403 = Int__PLUS_(idx, 2);
                                                        int cur = _403;
                                                        Array__RESP_MUL_ _407 = Array_allocate__RESP_MUL_(len);
                                                        Array__RESP_MUL_ a = _407;
                                                        static String _410 = "";
                                                        String *_410_ref = &_410;
                                                        String _411 = String_copy(_410_ref);
                                                        String err = _411;
                                                        /* let */ {
                                                            int i = 0;
                                                            bool _1000059 = Int__LT_(i, len);
                                                            bool _1000057 = _1000059;
                                                            while (_1000057) {
                                                                Lambda _425 = { .callback = (void*)RESP_decode_MINUS_one, .env = NULL, .delete = NULL, .copy = NULL }; //Sym RESP.decode-one LookupRecursive
                                                                Result__Pair__RESP_int_String _428 = _425.env ? ((Result__Pair__RESP_int_String(*)(LambdaEnv, String*, int))_425.callback)(_425.env, s, cur) : ((Result__Pair__RESP_int_String(*)(String*, int))_425.callback)(s, cur);
                                                                if(_428._tag == Result__Pair__RESP_int_String_Error_tag) {
                                                                    Result__Pair__RESP_int_String _428_temp = _428;
                                                                    String e = _428_temp.u.Error.member0;
                                                                    // Case expr:
                                                                    String_delete(err);
                                                                    err = e;  // String = String
                                                                    break;
                                                                ...
                                                                else if(_428._tag == Result__Pair__RESP_int_String_Success_tag) {
                                                                    Result__Pair__RESP_int_String _428_temp = _428;
                                                                    Pair__RESP_int p = _428_temp.u.Success.member0;
                                                                    // Case expr:
                                                                    Array__RESP_MUL_* _447 = &a; // ref
                                                                    Pair__RESP_int* _454 = &p; // ref
                                                                    RESP* _455 = Pair_a__RESP_int(_454);
                                                                    RESP _456 = RESP_copy(_455);
                                                                    RESP* _457 = Box_init__RESP(_456);
                                                                    Array_aset_MINUS_uninitialized_BANG___RESP_MUL_(_447, i, _457);
                                                                    Pair__RESP_int* _465 = &p; // ref
                                                                    int* _466 = Pair_b__RESP_int(_465);
                                                                    int _467 = Int_copy(_466);
                                                                    cur = _467;  // Int = Int
                                                                    Pair_delete__RESP_int(p);
                                                                }
                                                                else UNHANDLED("redis.carp", 96);
                                                                int _1000070 = Int__PLUS_(i, 1);
                                                                i = _1000070;  // Int = Int
                                                                bool _1000059 = Int__LT_(i, len);
                                                                _1000057 = _1000059;
                                                            }
                                                        }
                                                        Result__Pair__RESP_int_String _503;
                                                        String* _485 = &err; // ref
                                                        static String _486 = "";
                                                        String *_486_ref = &_486;
                                                        bool _487 = String__EQ_(_485, _486_ref);
                                                        if (_487) {
                                                            RESP _493 = RESP_Arr(a);
                                                            Pair__RESP_int _495 = Pair_init__RESP_int(_493, cur);
                                                            Result__Pair__RESP_int_String _496 = Result_Success__Pair__RESP_int_String(_495);
                                                            Result__Pair__RESP_int_String _497 = _496;
                                                            String_delete(err);
                                                            _503 = _497;
                                                        } else {
                                                            Result__Pair__RESP_int_String _501 = Result_Error__String_Pair__RESP_int(err);
                                                            Result__Pair__RESP_int_String _502 = _501;
                                                            Array_delete__RESP_MUL_(a);
                                                            _503 = _502;
                                                        }
                                                        Result__Pair__RESP_int_String _504 = _503;
                                                        _505 = _504;
                                                    }
                                                    Result__Pair__RESP_int_String _506 = _505;
                                                    _507 = _506;
                                                }
                                                Result__Pair__RESP_int_String _508 = _507;
                                                _509 = _508;
                                            }
                                            _510 = _509;
                                        }
                                        else UNHANDLED("redis.carp", 84);
                                        Result__Pair__RESP_int_String _511 = _510;
                                        String_delete(_348);
                                        _512 = _511;
                                    }
                                    _513 = _512;
                                }
                                Result__Pair__RESP_int_String _514 = _513;
                                _536 = _514;
                            } else {
                                static String _520 = "Malformed RESP data: got %s";
                                String *_520_ref = &_520;
                                int _528 = Int__PLUS_(pos, 1);
                                String _529 = String_slice(s, pos, _528);
                                String* _530 = &_529; // ref
                                String _1000077 = String_format(_520_ref, _530);
                                String* _1000075 = &_1000077; // ref
                                String _533 = String_copy(_1000075);
                                Result__Pair__RESP_int_String _534 = Result_Error__String_Pair__RESP_int(_533);
                                Result__Pair__RESP_int_String _535 = _534;
                                String_delete(_1000077);
                                String_delete(_529);
                                _536 = _535;
                            }
                            Result__Pair__RESP_int_String _537 = _536;
                            _538 = _537;
                        }
                        Result__Pair__RESP_int_String _539 = _538;
                        _540 = _539;
                    }
                    Result__Pair__RESP_int_String _541 = _540;
                    _542 = _541;
                }
                Result__Pair__RESP_int_String _543 = _542;
                _544 = _543;
            }
            _545 = _544;
        }
        Result__Pair__RESP_int_String _546 = _545;
        _547 = _546;
    }
    return _547;
}
...
void RESP_delete(RESP p) {
  if(p._tag == RESP_Null_tag) {

  }
  else if(p._tag == RESP_Str_tag) {
    String_delete(p.u.Str.member0);
  }
  else if(p._tag == RESP_Err_tag) {
    String_delete(p.u.Err.member0);
  }
  else if(p._tag == RESP_Integer_tag) {
    /* Ignore non-managed member 'u.Integer.member0' : Int */
  }
  else if(p._tag == RESP_Arr_tag) {
    Array_delete__RESP_MUL_(p.u.Arr.member0);
  }

}

Result__RESP_String RESP_from_MINUS_string(String* s) {
    Result__RESP_String _40;
    bool _7 = String_empty_QMARK_(s);
    if (_7) {
        RESP _11 = RESP_Null();
        Result__RESP_String _12 = Result_Success__RESP_String(_11);
        Result__RESP_String _13 = _12;
        _40 = _13;
    } else {
        Result__Pair__RESP_int_String _19 = RESP_decode_MINUS_one(s, 0);
        Result__RESP_String _38;
        if(_19._tag == Result__Pair__RESP_int_String_Error_tag) {
            Result__Pair__RESP_int_String _19_temp = _19;
            String e = _19_temp.u.Error.member0;
            // Case expr:
            Result__RESP_String _25 = Result_Error__String_RESP(e);
            _38 = _25;
        }
        else if(_19._tag == Result__Pair__RESP_int_String_Success_tag) {
            Result__Pair__RESP_int_String _19_temp = _19;
            Pair__RESP_int p = _19_temp.u.Success.member0;
            // Case expr:
            Pair__RESP_int* _34 = &p; // ref
            RESP* _35 = Pair_a__RESP_int(_34);
            RESP _36 = RESP_copy(_35);
            Result__RESP_String _37 = Result_Success__RESP_String(_36);
            _38 = _37;
            Pair_delete__RESP_int(p);
        }
        else UNHANDLED("redis.carp", 112);
        Result__RESP_String _39 = _38;
        _40 = _39;
    }
    return _40;
}

int RESP_get_MINUS_tag(RESP *p) { return p->_tag; }
String RESP_prn(RESP *p) {
  // convert members to String here:
  String temp = NULL;
  int tempsize = 0;
  ...
  if(p->_tag == RESP_Str_tag) {
    size += snprintf(NULL, 0, "(%s ", "Str");
  temp = String_prn(&p->u.Str.member0); 
  size += snprintf(NULL, 0, "%s ", temp);
  if(temp) { CARP_FREE(temp); temp = NULL; }

  }
  if(p->_tag == RESP_Err_tag) {
    size += snprintf(NULL, 0, "(%s ", "Err");
  temp = String_prn(&p->u.Err.member0); 
  size += snprintf(NULL, 0, "%s ", temp);
  if(temp) { CARP_FREE(temp); temp = NULL; }

  }
  if(p->_tag == RESP_Integer_tag) {
  ...
  if(p->_tag == RESP_Arr_tag) {
    size += snprintf(NULL, 0, "(%s ", "Arr");
  temp = Array_prn__RESP_MUL_(&p->u.Arr.member0); 
  size += snprintf(NULL, 0, "%s ", temp);
  if(temp) { CARP_FREE(temp); temp = NULL; }
  ...
  if(p->_tag == RESP_Str_tag) {
    bufferPtr += snprintf(bufferPtr, size - (bufferPtr - buffer), "(%s ", "Str");
  temp = String_prn(&p->u.Str.member0);
  tempsize = snprintf(bufferPtr, size - (bufferPtr - buffer), "%s ", temp);
  bufferPtr += tempsize;
  if(temp) { CARP_FREE(temp); temp = NULL; }
  ...
  if(p->_tag == RESP_Err_tag) {
    bufferPtr += snprintf(bufferPtr, size - (bufferPtr - buffer), "(%s ", "Err");
  temp = String_prn(&p->u.Err.member0);
  tempsize = snprintf(bufferPtr, size - (bufferPtr - buffer), "%s ", temp);
  bufferPtr += tempsize;
  if(temp) { CARP_FREE(temp); temp = NULL; }
  ...
  if(p->_tag == RESP_Arr_tag) {
    bufferPtr += snprintf(bufferPtr, size - (bufferPtr - buffer), "(%s ", "Arr");
  temp = Array_prn__RESP_MUL_(&p->u.Arr.member0);
  tempsize = snprintf(bufferPtr, size - (bufferPtr - buffer), "%s ", temp);
  bufferPtr += tempsize;
  if(temp) { CARP_FREE(temp); temp = NULL; }
...
String RESP_str(RESP* r) {
    ...
    else if(_7._tag == RESP_Str_tag) {
        RESP _7_temp = _7;
        String s = _7_temp.u.Str.member0;
        // Case expr:
        static String _21 = "$%d\r\n";
        String *_21_ref = &_21;
        String* _25 = &s; // ref
        int _26 = String_length(_25);
        String _1000008 = Int_format(_21_ref, _26);
        String* _1000006 = &_1000008; // ref
        static String _31 = "%s\r\n";
        String *_31_ref = &_31;
        String* _34 = &s; // ref
        String _1000011 = String_format(_31_ref, _34);
        String* _1000009 = &_1000011; // ref
        String _1000005 = String_append(_1000006, _1000009);
        String* _1000003 = &_1000005; // ref
        String _39 = String_copy(_1000003);
        _130 = _39;
    ...
    else if(_7._tag == RESP_Err_tag) {
        RESP _7_temp = _7;
        String s = _7_temp.u.Err.member0;
        // Case expr:
        static String _46 = "-%s\r\n";
        String *_46_ref = &_46;
        String* _49 = &s; // ref
        String _1000014 = String_format(_46_ref, _49);
        String* _1000012 = &_1000014; // ref
        String _52 = String_copy(_1000012);
        _130 = _52;
        String_delete(_1000014);
        String_delete(s);
    }
    else if(_7._tag == RESP_Integer_tag) {
        RESP _7_temp = _7;
        int i = _7_temp.u.Integer.member0;
        // Case expr:
        static String _59 = ":%d\r\n";
        String *_59_ref = &_59;
        String _1000017 = Int_format(_59_ref, i);
        String* _1000015 = &_1000017; // ref
        String _63 = String_copy(_1000015);
        _130 = _63;
        String_delete(_1000017);
    }
    else if(_7._tag == RESP_Arr_tag) {
        RESP _7_temp = _7;
        Array__RESP_MUL_ a = _7_temp.u.Arr.member0;
        // Case expr:
        String _129;
        /* let */ {
            Array _81 = { .len = 1, .capacity = 1, .data = CARP_MALLOC(sizeof(String) * 1) };
            static String _72 = "*%d\r\n";
            String *_72_ref = &_72;
            Array__RESP_MUL_* _76 = &a; // ref
            int _77 = Array_length__RESP_MUL_(_76);
            String _1000021 = Int_format(_72_ref, _77);
            String* _1000019 = &_1000021; // ref
            String _80 = String_copy(_1000019);
            ((String*)_81.data)[0] = _80;
            Array__String parts = _81;
            /* let */ {
                int i = 0;
                Array__RESP_MUL_* _94 = &a; // ref
                int _95 = Array_length__RESP_MUL_(_94);
                bool _1000027 = Int__LT_(i, _95);
                bool _1000025 = _1000027;
                while (_1000025) {
                    Array__String* _101 = &parts; // ref
                    Array__RESP_MUL_* _107 = &a; // ref
                    RESP** _109 = Array_unsafe_MINUS_nth__RESP_MUL_(_107, i);
                    RESP* _110 = Box_peek__RESP(_109);
                    String _111 = RESP_str(_110);
                    Array_push_MINUS_back_BANG___String(_101, _111);
                    int _1000032 = Int__PLUS_(i, 1);
                    i = _1000032;  // Int = Int
                    Array__RESP_MUL_* _94 = &a; // ref
                    int _95 = Array_length__RESP_MUL_(_94);
                    bool _1000027 = Int__LT_(i, _95);
            ...
            Array__String* _126 = &parts; // ref
            String _127 = String_concat(_126);
            String _128 = _127;
            _129 = _128;
            Array_delete__String(parts);
            String_delete(_1000021);
        }
        _130 = _129;
        Array_delete__RESP_MUL_(a);
    }
    else UNHANDLED("redis.carp", 18);
    return _130;
}
...
RESP* Redis__Lambda_send_20_env(String* x) {
    String _17 = String_copy(x);
    RESP _18 = String_to_MINUS_redis(_17);
    RESP* _19 = Box_init__RESP(_18);
    return _19;
}

RESP* Redis__Lambda_send_48_env(RESP* x) {
    RESP _46 = RESP_copy(x);
    RESP* _47 = Box_init__RESP(_46);
    return _47;
}

Result__RESP_String Redis_acl_MINUS_cat(Redis* r) {
    static String _8 = "acl cat";
    String *_8_ref = &_8;
    String _9 = String_copy(_8_ref);
    Array _11 = { .len = 0, .capacity = 0, .data = CARP_MALLOC(sizeof(RESP) * 0) };
    Array__RESP* _12 = &_11; // ref
    Redis_send(r, _9, _12);
    Result__RESP_String _16 = Redis_read(r);
    Result__RESP_String _17 = _16;
    Array_delete__RESP(_11);
    return _17;
}

Result__RESP_String Redis_acl_MINUS_genpass(Redis* r) {
    static String _8 = "acl genpass";
    String *_8_ref = &_8;
    String _9 = String_copy(_8_ref);
    Array _11 = { .len = 0, .capacity = 0, .data = CARP_MALLOC(sizeof(RESP) * 0) };
    Array__RESP* _12 = &_11; // ref
...
Result__RESP_String Redis_client_MINUS_getname(Redis* r) {
    static String _8 = "client getname";
    String *_8_ref = &_8;
    String _9 = String_copy(_8_ref);
    Array _11 = { .len = 0, .capacity = 0, .data = CARP_MALLOC(sizeof(RESP) * 0) };
    Array__RESP* _12 = &_11; // ref
...
Result__RESP_String Redis_client_MINUS_getredir(Redis* r) {
    static String _8 = "client getredir";
    String *_8_ref = &_8;
    String _9 = String_copy(_8_ref);
    Array _11 = { .len = 0, .capacity = 0, .data = CARP_MALLOC(sizeof(RESP) * 0) };
    Array__RESP* _12 = &_11; // ref
...
Result__RESP_String Redis_client_MINUS_trackinginfo(Redis* r) {
    static String _8 = "client trackinginfo";
    String *_8_ref = &_8;
    String _9 = String_copy(_8_ref);
    Array _11 = { .len = 0, .capacity = 0, .data = CARP_MALLOC(sizeof(RESP) * 0) };
    Array__RESP* _12 = &_11; // ref
...
void Redis_close(Redis r) {
    Redis* _9 = &r; // ref
    TcpStream* _10 = Redis_sock(_9);
    TcpStream _11 = TcpStream_copy(_10);
    TcpStream_close(_11);
    Redis_delete(r);
}

Result__RESP_String Redis_cluster_MINUS_bumpepoch(Redis* r) {
    static String _8 = "cluster bumpepoch";
    String *_8_ref = &_8;
    String _9 = String_copy(_8_ref);
    Array _11 = { .len = 0, .capacity = 0, .data = CARP_MALLOC(sizeof(RESP) * 0) };
    Array__RESP* _12 = &_11; // ref
...
Result__RESP_String Redis_cluster_MINUS_failover(Redis* r) {
    static String _8 = "cluster failover";
    String *_8_ref = &_8;
    String _9 = String_copy(_8_ref);
    Array _11 = { .len = 0, .capacity = 0, .data = CARP_MALLOC(sizeof(RESP) * 0) };
    Array__RESP* _12 = &_11; // ref
...
Result__RESP_String Redis_cluster_MINUS_flushslots(Redis* r) {
    static String _8 = "cluster flushslots";
    String *_8_ref = &_8;
    String _9 = String_copy(_8_ref);
    Array _11 = { .len = 0, .capacity = 0, .data = CARP_MALLOC(sizeof(RESP) * 0) };
    Array__RESP* _12 = &_11; // ref
...
Result__RESP_String Redis_cluster_MINUS_links(Redis* r) {
    static String _8 = "cluster links";
    String *_8_ref = &_8;
    String _9 = String_copy(_8_ref);
    Array _11 = { .len = 0, .capacity = 0, .data = CARP_MALLOC(sizeof(RESP) * 0) };
    Array__RESP* _12 = &_11; // ref
...
Result__RESP_String Redis_cluster_MINUS_nodes(Redis* r) {
    static String _8 = "cluster nodes";
    String *_8_ref = &_8;
    String _9 = String_copy(_8_ref);
    Array _11 = { .len = 0, .capacity = 0, .data = CARP_MALLOC(sizeof(RESP) * 0) };
    Array__RESP* _12 = &_11; // ref
...
Result__RESP_String Redis_cluster_MINUS_reset(Redis* r) {
    static String _8 = "cluster reset";
    String *_8_ref = &_8;
    String _9 = String_copy(_8_ref);
    Array _11 = { .len = 0, .capacity = 0, .data = CARP_MALLOC(sizeof(RESP) * 0) };
    Array__RESP* _12 = &_11; // ref
...
Result__RESP_String Redis_cluster_MINUS_saveconfig(Redis* r) {
    static String _8 = "cluster saveconfig";
    String *_8_ref = &_8;
    String _9 = String_copy(_8_ref);
    Array _11 = { .len = 0, .capacity = 0, .data = CARP_MALLOC(sizeof(RESP) * 0) };
    Array__RESP* _12 = &_11; // ref
...
Result__RESP_String Redis_cluster_MINUS_shards(Redis* r) {
    static String _8 = "cluster shards";
    String *_8_ref = &_8;
    String _9 = String_copy(_8_ref);
    Array _11 = { .len = 0, .capacity = 0, .data = CARP_MALLOC(sizeof(RESP) * 0) };
    Array__RESP* _12 = &_11; // ref
...
Result__RESP_String Redis_cluster_MINUS_slots(Redis* r) {
    static String _8 = "cluster slots";
    String *_8_ref = &_8;
    String _9 = String_copy(_8_ref);
    Array _11 = { .len = 0, .capacity = 0, .data = CARP_MALLOC(sizeof(RESP) * 0) };
    Array__RESP* _12 = &_11; // ref
...
Result__RESP_String Redis_command_MINUS_count(Redis* r) {
    static String _8 = "command count";
    String *_8_ref = &_8;
    String _9 = String_copy(_8_ref);
    Array _11 = { .len = 0, .capacity = 0, .data = CARP_MALLOC(sizeof(RESP) * 0) };
    Array__RESP* _12 = &_11; // ref
...
Result__RESP_String Redis_command_MINUS_getkeys(Redis* r) {
    static String _8 = "command getkeys";
    String *_8_ref = &_8;
    String _9 = String_copy(_8_ref);
    Array _11 = { .len = 0, .capacity = 0, .data = CARP_MALLOC(sizeof(RESP) * 0) };
    Array__RESP* _12 = &_11; // ref
...
Result__RESP_String Redis_config_MINUS_resetstat(Redis* r) {
    static String _8 = "config resetstat";
    String *_8_ref = &_8;
    String _9 = String_copy(_8_ref);
    Array _11 = { .len = 0, .capacity = 0, .data = CARP_MALLOC(sizeof(RESP) * 0) };
    Array__RESP* _12 = &_11; // ref
...
Result__RESP_String Redis_config_MINUS_rewrite(Redis* r) {
    static String _8 = "config rewrite";
    String *_8_ref = &_8;
    String _9 = String_copy(_8_ref);
    Array _11 = { .len = 0, .capacity = 0, .data = CARP_MALLOC(sizeof(RESP) * 0) };
    Array__RESP* _12 = &_11; // ref
...
Result__RESP_String Redis_debug_MINUS_segfault(Redis* r) {
    static String _8 = "debug segfault";
    String *_8_ref = &_8;
    String _9 = String_copy(_8_ref);
    Array _11 = { .len = 0, .capacity = 0, .data = CARP_MALLOC(sizeof(RESP) * 0) };
    Array__RESP* _12 = &_11; // ref
...
void Redis_delete(Redis p) {
    /* Ignore non-managed member 'sock' : TcpStream */
}

Result__RESP_String Redis_discard(Redis* r) {
    static String _8 = "discard";
    String *_8_ref = &_8;
    String _9 = String_copy(_8_ref);
    Array _11 = { .len = 0, .capacity = 0, .data = CARP_MALLOC(sizeof(RESP) * 0) };
    Array__RESP* _12 = &_11; // ref
...
Result__RESP_String Redis_function_MINUS_dump(Redis* r) {
    static String _8 = "function dump";
    String *_8_ref = &_8;
    String _9 = String_copy(_8_ref);
    Array _11 = { .len = 0, .capacity = 0, .data = CARP_MALLOC(sizeof(RESP) * 0) };
    Array__RESP* _12 = &_11; // ref
...
Result__RESP_String Redis_function_MINUS_flush(Redis* r) {
    static String _8 = "function flush";
    String *_8_ref = &_8;
    String _9 = String_copy(_8_ref);
    Array _11 = { .len = 0, .capacity = 0, .data = CARP_MALLOC(sizeof(RESP) * 0) };
    Array__RESP* _12 = &_11; // ref
...
Result__RESP_String Redis_function_MINUS_list(Redis* r) {
    static String _8 = "function list";
    String *_8_ref = &_8;
    String _9 = String_copy(_8_ref);
    Array _11 = { .len = 0, .capacity = 0, .data = CARP_MALLOC(sizeof(RESP) * 0) };
    Array__RESP* _12 = &_11; // ref
...
Result__RESP_String Redis_function_MINUS_stats(Redis* r) {
    static String _8 = "function stats";
    String *_8_ref = &_8;
    String _9 = String_copy(_8_ref);
    Array _11 = { .len = 0, .capacity = 0, .data = CARP_MALLOC(sizeof(RESP) * 0) };
    Array__RESP* _12 = &_11; // ref
...
Result__RESP_String Redis_latency_MINUS_doctor(Redis* r) {
    static String _8 = "latency doctor";
    String *_8_ref = &_8;
    String _9 = String_copy(_8_ref);
    Array _11 = { .len = 0, .capacity = 0, .data = CARP_MALLOC(sizeof(RESP) * 0) };
    Array__RESP* _12 = &_11; // ref
...
Result__RESP_String Redis_latency_MINUS_histogram(Redis* r) {
    static String _8 = "latency histogram";
    String *_8_ref = &_8;
    String _9 = String_copy(_8_ref);
    Array _11 = { .len = 0, .capacity = 0, .data = CARP_MALLOC(sizeof(RESP) * 0) };
    Array__RESP* _12 = &_11; // ref
...
Result__RESP_String Redis_latency_MINUS_latest(Redis* r) {
    static String _8 = "latency latest";
    String *_8_ref = &_8;
    String _9 = String_copy(_8_ref);
    Array _11 = { .len = 0, .capacity = 0, .data = CARP_MALLOC(sizeof(RESP) * 0) };
    Array__RESP* _12 = &_11; // ref
...
Result__RESP_String Redis_latency_MINUS_reset(Redis* r) {
    static String _8 = "latency reset";
    String *_8_ref = &_8;
    String _9 = String_copy(_8_ref);
    Array _11 = { .len = 0, .capacity = 0, .data = CARP_MALLOC(sizeof(RESP) * 0) };
    Array__RESP* _12 = &_11; // ref
...
Result__RESP_String Redis_memory_MINUS_doctor(Redis* r) {
    static String _8 = "memory doctor";
    String *_8_ref = &_8;
    String _9 = String_copy(_8_ref);
    Array _11 = { .len = 0, .capacity = 0, .data = CARP_MALLOC(sizeof(RESP) * 0) };
    Array__RESP* _12 = &_11; // ref
...
Result__RESP_String Redis_memory_MINUS_malloc_MINUS_stats(Redis* r) {
    static String _8 = "memory malloc stats";
    String *_8_ref = &_8;
    String _9 = String_copy(_8_ref);
    Array _11 = { .len = 0, .capacity = 0, .data = CARP_MALLOC(sizeof(RESP) * 0) };
    Array__RESP* _12 = &_11; // ref
...
Result__Redis_String Redis_open(String* host) {
    Result__Redis_String _7 = Redis_open_MINUS_on(host, 6379);
    return _7;
}

Result__Redis_String Redis_open_MINUS_on(String* host, int port) {
    Result__TcpStream_String _9 = TcpStream_connect(host, port);
    Result__Redis_String _53;
    if(_9._tag == Result__TcpStream_String_Success_tag) {
        Result__TcpStream_String _9_temp = _9;
        TcpStream s = _9_temp.u.Success.member0;
        // Case expr:
        Redis _16 = Redis_init(s);
        Result__Redis_String _17 = Result_Success__Redis_String(_16);
        _53 = _17;
    }
    else if(_9._tag == Result__TcpStream_String_Error_tag) {
        Result__TcpStream_String _9_temp = _9;
        String e = _9_temp.u.Error.member0;
        // Case expr:
        static String _27 = "Couldn’t connect to %s:";
        String *_27_ref = &_27;
        String _1000008 = String_format(_27_ref, host);
        String* _1000006 = &_1000008; // ref
        static String _35 = "%d: ";
        String *_35_ref = &_35;
        String _1000014 = Int_format(_35_ref, port);
        String* _1000012 = &_1000014; // ref
        static String _41 = "%s";
        String *_41_ref = &_41;
        String* _44 = &e; // ref
        String _1000017 = String_format(_41_ref, _44);
        String* _1000015 = &_1000017; // ref
        String _1000011 = String_append(_1000012, _1000015);
        String* _1000009 = &_1000011; // ref
        String _1000005 = String_append(_1000006, _1000009);
        String* _1000003 = &_1000005; // ref
        String _51 = String_copy(_1000003);
        Result__Redis_String _52 = Result_Error__String_Redis(_51);
        _53 = _52;
        String_delete(_1000005);
        String_delete(_1000008);
        String_delete(_1000011);
    ...
    else UNHANDLED("redis.carp", 133);
    return _53;
}

Result__RESP_String Redis_ping(Redis* r) {
    static String _8 = "ping";
    String *_8_ref = &_8;
    String _9 = String_copy(_8_ref);
    Array _11 = { .len = 0, .capacity = 0, .data = CARP_MALLOC(sizeof(RESP) * 0) };
    Array__RESP* _12 = &_11; // ref
...
String Redis_prn(Redis *p) {
  ...
  int tempsize = 0;
  (void)tempsize; // that way we remove the occasional unused warning 
  int size = snprintf(NULL, 0, "(%s )", "Redis");
  // Failed to find str function for sock : TcpStream


  String buffer = CARP_MALLOC(size);
  String bufferPtr = buffer;

  bufferPtr += snprintf(bufferPtr, size - (bufferPtr - buffer), "(%s ", "Redis");
  // Failed to find str function for sock : TcpStream
...
Result__RESP_String Redis_read(Redis* r) {
    TcpStream* _13 = Redis_sock(r);
    Result__String_String _14 = TcpStream_read__String(_13);
    Result__String_String _15 = _14; // From the 'the' function.
    Result__RESP_String _30;
    if(_15._tag == Result__String_String_Success_tag) {
        Result__String_String _15_temp = _15;
        String s = _15_temp.u.Success.member0;
        // Case expr:
        String* _22 = &s; // ref
        Result__RESP_String _23 = RESP_from_MINUS_string(_22);
        _30 = _23;
        String_delete(s);
    }
    else if(_15._tag == Result__String_String_Error_tag) {
        Result__String_String _15_temp = _15;
        String e = _15_temp.u.Error.member0;
        // Case expr:
        Result__RESP_String _29 = Result_Error__String_RESP(e);
        _30 = _29;
    }
    else UNHANDLED("redis.carp", 145);
    return _30;
}

Result__RESP_String Redis_readonly(Redis* r) {
    static String _8 = "readonly";
    String *_8_ref = &_8;
    String _9 = String_copy(_8_ref);
    Array _11 = { .len = 0, .capacity = 0, .data = CARP_MALLOC(sizeof(RESP) * 0) };
    Array__RESP* _12 = &_11; // ref
...
void Redis_send(Redis* r, String cmd, Array__RESP* args) {
    /* let */ {
        // This lambda captures 0 variables: 
        Lambda _20 = {
          .callback = (void*)Redis__Lambda_send_20_env,
          .env = NULL,
          .delete = (void*)NULL,
          .copy = (void*)NULL
        };
        ...
        String *_24_ref = &_24;
        String* _27 = &cmd; // ref
        Array__String _28 = Pattern_split(_24_ref, _27);
        Array__String* _29 = &_28; // ref
        Array__RESP_MUL_ _30 = Array_copy_MINUS_map__String_RESP_MUL_(_21, _29);
        Array__RESP_MUL_ cmd_MINUS_parts = _30;
        Array _52 = { .len = 2, .capacity = 2, .data = CARP_MALLOC(sizeof(Array__RESP_MUL_) * 2) };
        ((Array__RESP_MUL_*)_52.data)[0] = cmd_MINUS_parts;
        // This lambda captures 0 variables: 
        Lambda _48 = {
          .callback = (void*)Redis__Lambda_send_48_env,
          .env = NULL,
          .delete = (void*)NULL,
          .copy = (void*)NULL
        };
        Lambda* _49 = &_48; // ref
        Array__RESP_MUL_ _51 = Array_copy_MINUS_map__RESP_RESP_MUL_(_49, args);
        ((Array__RESP_MUL_*)_52.data)[1] = _51;
        Array__Array__RESP_MUL_* _53 = &_52; // ref
        Array__RESP_MUL_ _54 = Array_concat__RESP_MUL_(_53);
        RESP _55 = RESP_Arr(_54);
        RESP* _56 = &_55; // ref
        String _57 = RESP_str(_56);
        String msg = _57;
        /* let */ {
            TcpStream* _64 = Redis_sock(r);
            String* _67 = &msg; // ref
            Result__int_String _68 = TcpStream_send(_64, _67);
            Result__int_String _ = _68;
            /* () */
            Result_delete__int_String(_);
        }
        Array_delete__Array__RESP_MUL_(_52);
        Array_delete__String(_28);
        Function_delete__RESP_MUL__RESP_MUL_(_48);
        Function_delete__String_MUL__RESP_MUL_(_20);
        RESP_delete(_55);
        String_delete(msg);
    }
    String_delete(cmd);
...
TcpStream* Redis_sock(Redis* p) { return (&(p->sock)); }
...
Redis Redis_update_MINUS_sock(Redis p, Lambda *updater) {
    p.sock = (*updater).env ? ((Fn__LambdaEnv_TcpStream_TcpStream)(*updater).callback)((*updater).env, p.sock) : ((Fn__TcpStream_TcpStream)(*updater).callback)(p.sock);
    return p;
}


Result__RESP_String Redis_xgroup(Redis* r) {
    static String _8 = "xgroup";
    String *_8_ref = &_8;
    String _9 = String_copy(_8_ref);
    Array _11 = { .len = 0, .capacity = 0, .data = CARP_MALLOC(sizeof(RESP) * 0) };
    Array__RESP* _12 = &_11; // ref
...
Result__Pair__Array__uint8_t_String_String Result_Error__String_Pair__Array__uint8_t_String(String member0) {
  Result__Pair__Array__uint8_t_String_String instance;
    instance.u.Error.member0 = member0;
    instance._tag = Result__Pair__Array__uint8_t_String_String_Error_tag;
    return instance;
}

Result__Pair__RESP_int_String Result_Error__String_Pair__RESP_int(String member0) {
  Result__Pair__RESP_int_String instance;
    instance.u.Error.member0 = member0;
    instance._tag = Result__Pair__RESP_int_String_Error_tag;
    return instance;
}

Result__Poll_String Result_Error__String_Poll(String member0) {
  Result__Poll_String instance;
    instance.u.Error.member0 = member0;
    instance._tag = Result__Poll_String_Error_tag;
    return instance;
}

Result__RESP_String Result_Error__String_RESP(String member0) {
  Result__RESP_String instance;
    instance.u.Error.member0 = member0;
    instance._tag = Result__RESP_String_Error_tag;
    return instance;
}

Result__Redis_String Result_Error__String_Redis(String member0) {
  Result__Redis_String instance;
    instance.u.Error.member0 = member0;
    instance._tag = Result__Redis_String_Error_tag;
    return instance;
}
...
Result__TcpListener_String Result_Error__String_TcpListener(String member0) {
  Result__TcpListener_String instance;
    instance.u.Error.member0 = member0;
    instance._tag = Result__TcpListener_String_Error_tag;
    return instance;
}

Result__TcpStream_String Result_Error__String_TcpStream(String member0) {
  Result__TcpStream_String instance;
    instance.u.Error.member0 = member0;
    instance._tag = Result__TcpStream_String_Error_tag;
    return instance;
}

Result__UdpSocket_String Result_Error__String_UdpSocket(String member0) {
  Result__UdpSocket_String instance;
    instance.u.Error.member0 = member0;
    instance._tag = Result__UdpSocket_String_Error_tag;
    return instance;
}

Result__UnixListener_String Result_Error__String_UnixListener(String member0) {
  Result__UnixListener_String instance;
    instance.u.Error.member0 = member0;
    instance._tag = Result__UnixListener_String_Error_tag;
    return instance;
}

Result__UnixStream_String Result_Error__String_UnixStream(String member0) {
  Result__UnixStream_String instance;
    instance.u.Error.member0 = member0;
    instance._tag = Result__UnixStream_String_Error_tag;
    return instance;
}
...
Result__void_String Result_Error__String_void(String member0) {
  Result__void_String instance;
    instance.u.Error.member0 = member0;
    instance._tag = Result__void_String_Error_tag;
    return instance;
}
...
Result__Pair__Array__uint8_t_String_String Result_Success__Pair__Array__uint8_t_String_String(Pair__Array__uint8_t_String member0) {
  Result__Pair__Array__uint8_t_String_String instance;
    instance.u.Success.member0 = member0;
    instance._tag = Result__Pair__Array__uint8_t_String_String_Success_tag;
    return instance;
}
...
Result__Pair__RESP_int_String Result_Success__Pair__RESP_int_String(Pair__RESP_int member0) {
  Result__Pair__RESP_int_String instance;
    instance.u.Success.member0 = member0;
    instance._tag = Result__Pair__RESP_int_String_Success_tag;
    return instance;
}
...
Result__Poll_String Result_Success__Poll_String(Poll member0) {
  Result__Poll_String instance;
    instance.u.Success.member0 = member0;
    instance._tag = Result__Poll_String_Success_tag;
    return instance;
}
...
Result__RESP_String Result_Success__RESP_String(RESP member0) {
  Result__RESP_String instance;
    instance.u.Success.member0 = member0;
    instance._tag = Result__RESP_String_Success_tag;
    return instance;
}
...
Result__Redis_String Result_Success__Redis_String(Redis member0) {
  Result__Redis_String instance;
    instance.u.Success.member0 = member0;
    instance._tag = Result__Redis_String_Success_tag;
    return instance;
}
...
Result__TcpListener_String Result_Success__TcpListener_String(TcpListener member0) {
  Result__TcpListener_String instance;
    instance.u.Success.member0 = member0;
    instance._tag = Result__TcpListener_String_Success_tag;
    return instance;
}
...
Result__TcpStream_String Result_Success__TcpStream_String(TcpStream member0) {
  Result__TcpStream_String instance;
    instance.u.Success.member0 = member0;
    instance._tag = Result__TcpStream_String_Success_tag;
    return instance;
}
...
Result__UdpSocket_String Result_Success__UdpSocket_String(UdpSocket member0) {
  Result__UdpSocket_String instance;
    instance.u.Success.member0 = member0;
    instance._tag = Result__UdpSocket_String_Success_tag;
    return instance;
}
...
Result__UnixListener_String Result_Success__UnixListener_String(UnixListener member0) {
  Result__UnixListener_String instance;
    instance.u.Success.member0 = member0;
    instance._tag = Result__UnixListener_String_Success_tag;
    return instance;
}
...
Result__UnixStream_String Result_Success__UnixStream_String(UnixStream member0) {
  Result__UnixStream_String instance;
    instance.u.Success.member0 = member0;
    instance._tag = Result__UnixStream_String_Success_tag;
    return instance;
}
...
Result__void_String Result_Success__void_String() {
  Result__void_String instance;
    ...
    instance._tag = Result__void_String_Success_tag;
    return instance;
}
...
void Result_delete__Pair__Array__uint8_t_String_String(Result__Pair__Array__uint8_t_String_String p) {
  if(p._tag == Result__Pair__Array__uint8_t_String_String_Success_tag) {
    Pair_delete__Array__uint8_t_String(p.u.Success.member0);
  }
  else if(p._tag == Result__Pair__Array__uint8_t_String_String_Error_tag) {
    String_delete(p.u.Error.member0);
  }
...
void Result_delete__Pair__RESP_int_String(Result__Pair__RESP_int_String p) {
  if(p._tag == Result__Pair__RESP_int_String_Success_tag) {
    Pair_delete__RESP_int(p.u.Success.member0);
  }
  else if(p._tag == Result__Pair__RESP_int_String_Error_tag) {
    String_delete(p.u.Error.member0);
  }
...
void Result_delete__Poll_String(Result__Poll_String p) {
  if(p._tag == Result__Poll_String_Success_tag) {
    /* Ignore non-managed member 'u.Success.member0' : Poll */
  }
  else if(p._tag == Result__Poll_String_Error_tag) {
    String_delete(p.u.Error.member0);
  }
...
void Result_delete__RESP_String(Result__RESP_String p) {
  if(p._tag == Result__RESP_String_Success_tag) {
    RESP_delete(p.u.Success.member0);
  }
  else if(p._tag == Result__RESP_String_Error_tag) {
    String_delete(p.u.Error.member0);
  }
...
void Result_delete__Redis_String(Result__Redis_String p) {
  if(p._tag == Result__Redis_String_Success_tag) {
    Redis_delete(p.u.Success.member0);
  }
  else if(p._tag == Result__Redis_String_Error_tag) {
    String_delete(p.u.Error.member0);
  }
...
void Result_delete__TcpListener_String(Result__TcpListener_String p) {
  if(p._tag == Result__TcpListener_String_Success_tag) {
    /* Ignore non-managed member 'u.Success.member0' : TcpListener */
  }
  else if(p._tag == Result__TcpListener_String_Error_tag) {
    String_delete(p.u.Error.member0);
  }
...
void Result_delete__TcpStream_String(Result__TcpStream_String p) {
  if(p._tag == Result__TcpStream_String_Success_tag) {
    /* Ignore non-managed member 'u.Success.member0' : TcpStream */
  }
  else if(p._tag == Result__TcpStream_String_Error_tag) {
    String_delete(p.u.Error.member0);
  }
...
void Result_delete__UdpSocket_String(Result__UdpSocket_String p) {
  if(p._tag == Result__UdpSocket_String_Success_tag) {
    /* Ignore non-managed member 'u.Success.member0' : UdpSocket */
  }
  else if(p._tag == Result__UdpSocket_String_Error_tag) {
    String_delete(p.u.Error.member0);
  }
...
void Result_delete__UnixListener_String(Result__UnixListener_String p) {
  if(p._tag == Result__UnixListener_String_Success_tag) {
    /* Ignore non-managed member 'u.Success.member0' : UnixListener */
  }
  else if(p._tag == Result__UnixListener_String_Error_tag) {
    String_delete(p.u.Error.member0);
  }
...
void Result_delete__UnixStream_String(Result__UnixStream_String p) {
  if(p._tag == Result__UnixStream_String_Success_tag) {
    /* Ignore non-managed member 'u.Success.member0' : UnixStream */
  }
  else if(p._tag == Result__UnixStream_String_Error_tag) {
    String_delete(p.u.Error.member0);
  }
...
void Result_delete__void_String(Result__void_String p) {
  if(p._tag == Result__void_String_Success_tag) {

  }
  else if(p._tag == Result__void_String_Error_tag) {
    String_delete(p.u.Error.member0);
  }
...
Result__TcpStream_String TcpListener_accept(TcpListener* listener) {
    Result__TcpStream_String _31;
    /* let */ {
        TcpStream _8 = TcpListener_accept_(listener);
        TcpStream s = _8;
        Result__TcpStream_String _30;
        TcpStream* _15 = &s; // ref
        int _16 = TcpStream_fd_(_15);
        bool _18 = Int__EQ_(_16, -1);
        if (_18) {
            String _22 = System_error_MINUS_text();
            Result__TcpStream_String _23 = Result_Error__String_TcpStream(_22);
            Result__TcpStream_String _24 = _23;
            _30 = _24;
        } else {
            Result__TcpStream_String _28 = Result_Success__TcpStream_String(s);
            Result__TcpStream_String _29 = _28;
            _30 = _29;
        }
        _31 = _30;
    }
...
Result__TcpListener_String TcpListener_bind(String* addr, int port) {
    Result__TcpListener_String _33;
    /* let */ {
        TcpListener _10 = TcpListener_bind_(addr, port);
        TcpListener l = _10;
        Result__TcpListener_String _32;
        TcpListener* _17 = &l; // ref
        int _18 = TcpListener_fd_(_17);
        bool _20 = Int__EQ_(_18, -1);
        if (_20) {
            String _24 = System_error_MINUS_text();
            Result__TcpListener_String _25 = Result_Error__String_TcpListener(_24);
            Result__TcpListener_String _26 = _25;
            _32 = _26;
        } else {
            Result__TcpListener_String _30 = Result_Success__TcpListener_String(l);
            Result__TcpListener_String _31 = _30;
            _32 = _31;
        }
        _33 = _32;
    }
...
int TcpListener_poll_MINUS_fd(TcpListener* l) {
    int _6 = TcpListener_fd_(l);
    return _6;
}

Result__TcpStream_String TcpStream_connect(String* addr, int port) {
    Result__TcpStream_String _33;
    /* let */ {
        TcpStream _10 = TcpStream_connect_(addr, port);
        TcpStream s = _10;
        Result__TcpStream_String _32;
        TcpStream* _17 = &s; // ref
        int _18 = TcpStream_fd_(_17);
        bool _20 = Int__EQ_(_18, -1);
        if (_20) {
            String _24 = System_error_MINUS_text();
            Result__TcpStream_String _25 = Result_Error__String_TcpStream(_24);
            Result__TcpStream_String _26 = _25;
            _32 = _26;
        } else {
            Result__TcpStream_String _30 = Result_Success__TcpStream_String(s);
            Result__TcpStream_String _31 = _30;
            _32 = _31;
        }
        _33 = _32;
    }
...
Result__TcpStream_String TcpStream_connect_MINUS_timeout(String* addr, int port, int timeout) {
    Result__TcpStream_String _35;
    /* let */ {
        TcpStream _12 = TcpStream_connect_MINUS_timeout_(addr, port, timeout);
        TcpStream s = _12;
        Result__TcpStream_String _34;
        TcpStream* _19 = &s; // ref
        int _20 = TcpStream_fd_(_19);
        bool _22 = Int__EQ_(_20, -1);
        if (_22) {
            String _26 = System_error_MINUS_text();
            Result__TcpStream_String _27 = Result_Error__String_TcpStream(_26);
            Result__TcpStream_String _28 = _27;
            _34 = _28;
        } else {
            Result__TcpStream_String _32 = Result_Success__TcpStream_String(s);
            Result__TcpStream_String _33 = _32;
            _34 = _33;
        }
        _35 = _34;
    }
...
Result__int_String TcpStream_read_MINUS_append(TcpStream* stream, Array__uint8_t* buf) {
    Result__int_String _29;
    /* let */ {
        int _10 = TcpStream_read_MINUS_append_(stream, buf);
        int n = _10;
        Result__int_String _28;
        bool _16 = Int__EQ_(n, -1);
        if (_16) {
            String _20 = System_error_MINUS_text();
            Result__int_String _21 = Result_Error__String_int(_20);
            Result__int_String _22 = _21;
            _28 = _22;
        } else {
            Result__int_String _26 = Result_Success__int_String(n);
...
Result__String_String TcpStream_read__String(TcpStream* stream) {
    Result__String_String _13;
    /* let */ {
        String _8 = TcpStream_read_(stream);
        String s = _8;
        Result__String_String _12 = Result_Success__String_String(s);
        _13 = _12;
    }
    return _13;
}
...
Result__int_String TcpStream_send(TcpStream* stream, String* msg) {
    Result__int_String _29;
    /* let */ {
        int _10 = TcpStream_send_(stream, msg);
        int n = _10;
        Result__int_String _28;
        bool _16 = Int__EQ_(n, -1);
        if (_16) {
...
Result__int_String TcpStream_send_MINUS_bytes(TcpStream* stream, Array__uint8_t* data) {
    Result__int_String _29;
    /* let */ {
        int _10 = TcpStream_send_MINUS_bytes_(stream, data);
        int n = _10;
        Result__int_String _28;
        bool _16 = Int__EQ_(n, -1);
        if (_16) {
...
Result__int_String TcpStream_send_MINUS_len(TcpStream* stream, String* msg, int len) {
    Result__int_String _31;
    /* let */ {
        int _12 = TcpStream_send_MINUS_len_(stream, msg, len);
        int n = _12;
        Result__int_String _30;
        bool _18 = Int__EQ_(n, -1);
        if (_18) {
            String _22 = System_error_MINUS_text();
            Result__int_String _23 = Result_Error__String_int(_22);
            Result__int_String _24 = _23;
            _30 = _24;
        } else {
            Result__int_String _28 = Result_Success__int_String(n);
            Result__int_String _29 = _28;
            _30 = _29;
        }
        _31 = _30;
    }
...
void TcpStream_shutdown(TcpStream* stream, int how) {
    TcpStream_shutdown_(stream, how);
}

Result__UdpSocket_String UdpSocket_bind(String* addr, int port) {
    Result__UdpSocket_String _33;
    /* let */ {
        UdpSocket _10 = UdpSocket_bind_(addr, port);
        UdpSocket u = _10;
        Result__UdpSocket_String _32;
        UdpSocket* _17 = &u; // ref
        int _18 = UdpSocket_fd_(_17);
        bool _20 = Int__EQ_(_18, -1);
        if (_20) {
            String _24 = System_error_MINUS_text();
            Result__UdpSocket_String _25 = Result_Error__String_UdpSocket(_24);
            Result__UdpSocket_String _26 = _25;
            _32 = _26;
        } else {
            Result__UdpSocket_String _30 = Result_Success__UdpSocket_String(u);
            Result__UdpSocket_String _31 = _30;
            _32 = _31;
        }
        _33 = _32;
    }
...
int UdpSocket_poll_MINUS_fd(UdpSocket* s) {
    int _6 = UdpSocket_fd_(s);
    return _6;
}

Result__Pair__Array__uint8_t_String_String UdpSocket_recv_MINUS_from(UdpSocket* sock) {
    Result__Pair__Array__uint8_t_String_String _75;
    /* let */ {
        Array__uint8_t _12 = Array_allocate__uint8_t(4096);
        Array__uint8_t _13 = _12; // From the 'the' function.
        Array__uint8_t buf = _13;
        static String _16 = "";
        String *_16_ref = &_16;
        String _17 = String_copy(_16_ref);
        String sender = _17;
        int port = 0;
        Array__uint8_t* _25 = &buf; // ref
        String* _28 = &sender; // ref
        int* _31 = &port; // ref
        int _32 = UdpSocket_recv_(sock, _25, _28, _31);
        int n = _32;
        Result__Pair__Array__uint8_t_String_String _73;
        bool _39 = Int__EQ_(n, -1);
        if (_39) {
            String _43 = System_error_MINUS_text();
            Result__Pair__Array__uint8_t_String_String _44 = Result_Error__String_Pair__Array__uint8_t_String(_43);
            Result__Pair__Array__uint8_t_String_String _45 = _44;
            Array_delete__uint8_t(buf);
            _73 = _45;
        } else {
            static String _55 = "%s:";
            String *_55_ref = &_55;
            String* _58 = &sender; // ref
            String _1000013 = String_format(_55_ref, _58);
            String* _1000011 = &_1000013; // ref
            static String _63 = "%d";
            String *_63_ref = &_63;
            String _1000016 = Int_format(_63_ref, port);
            String* _1000014 = &_1000016; // ref
            String _1000010 = String_append(_1000011, _1000014);
            String* _1000008 = &_1000010; // ref
            String _69 = String_copy(_1000008);
            Pair__Array__uint8_t_String _70 = Pair_init__Array__uint8_t_String(buf, _69);
            Result__Pair__Array__uint8_t_String_String _71 = Result_Success__Pair__Array__uint8_t_String_String(_70);
            Result__Pair__Array__uint8_t_String_String _72 = _71;
            String_delete(_1000010);
            String_delete(_1000013);
            String_delete(_1000016);
            _73 = _72;
        }
        Result__Pair__Array__uint8_t_String_String _74 = _73;
        _75 = _74;
        String_delete(sender);
    }
    return _75;
}
...
Result__int_String UdpSocket_send_MINUS_to(UdpSocket* sock, String* host, int port, Array__uint8_t* data) {
    ...
    /* let */ {
        int _14 = UdpSocket_send_MINUS_to_(sock, host, port, data);
        int n = _14;
        Result__int_String _32;
        bool _20 = Int__EQ_(n, -1);
        if (_20) {
            String _24 = System_error_MINUS_text();
            Result__int_String _25 = Result_Error__String_int(_24);
            Result__int_String _26 = _25;
            _32 = _26;
        } else {
            Result__int_String _30 = Result_Success__int_String(n);
            Result__int_String _31 = _30;
            _32 = _31;
        }
        _33 = _32;
    }
...
Result__UnixStream_String UnixListener_accept(UnixListener* listener) {
    Result__UnixStream_String _31;
    /* let */ {
        UnixStream _8 = UnixListener_accept_(listener);
        UnixStream s = _8;
        Result__UnixStream_String _30;
        UnixStream* _15 = &s; // ref
        int _16 = UnixStream_fd_(_15);
        bool _18 = Int__EQ_(_16, -1);
        if (_18) {
            String _22 = System_error_MINUS_text();
            Result__UnixStream_String _23 = Result_Error__String_UnixStream(_22);
            Result__UnixStream_String _24 = _23;
            _30 = _24;
        } else {
            Result__UnixStream_String _28 = Result_Success__UnixStream_String(s);
            Result__UnixStream_String _29 = _28;
            _30 = _29;
        }
        _31 = _30;
    }
...
Result__UnixListener_String UnixListener_bind(String* path) {
    Result__UnixListener_String _31;
    /* let */ {
        UnixListener _8 = UnixListener_bind_(path);
        UnixListener l = _8;
        Result__UnixListener_String _30;
        UnixListener* _15 = &l; // ref
        int _16 = UnixListener_fd_(_15);
        bool _18 = Int__EQ_(_16, -1);
        if (_18) {
            String _22 = System_error_MINUS_text();
            Result__UnixListener_String _23 = Result_Error__String_UnixListener(_22);
            Result__UnixListener_String _24 = _23;
            _30 = _24;
        } else {
            Result__UnixListener_String _28 = Result_Success__UnixListener_String(l);
            Result__UnixListener_String _29 = _28;
            _30 = _29;
        }
        _31 = _30;
    }
...
Result__UnixStream_String UnixStream_connect(String* path) {
    Result__UnixStream_String _31;
    /* let */ {
        UnixStream _8 = UnixStream_connect_(path);
        UnixStream s = _8;
        Result__UnixStream_String _30;
        UnixStream* _15 = &s; // ref
        int _16 = UnixStream_fd_(_15);
...
Result__int_String UnixStream_read_MINUS_append(UnixStream* stream, Array__uint8_t* buf) {
    Result__int_String _29;
    /* let */ {
        int _10 = UnixStream_read_MINUS_append_(stream, buf);
        int n = _10;
        Result__int_String _28;
        bool _16 = Int__EQ_(n, -1);
        if (_16) {
...
Result__int_String UnixStream_send(UnixStream* stream, String* msg) {
    Result__int_String _29;
    /* let */ {
        int _10 = UnixStream_send_(stream, msg);
        int n = _10;
        Result__int_String _28;
        bool _16 = Int__EQ_(n, -1);
        if (_16) {
...
Result__int_String UnixStream_send_MINUS_bytes(UnixStream* stream, Array__uint8_t* data) {
    Result__int_String _29;
    /* let */ {
        int _10 = UnixStream_send_MINUS_bytes_(stream, data);
        int n = _10;
        Result__int_String _28;
        bool _16 = Int__EQ_(n, -1);
        if (_16) {
...
void UnixStream_shutdown(UnixStream* stream, int how) {
    UnixStream_shutdown_(stream, how);
}
